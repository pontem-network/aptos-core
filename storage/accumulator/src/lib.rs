...
use pont_crypto::hash::{CryptoHash, CryptoHasher, HashValue, ACCUMULATOR_PLACEHOLDER_HASH};
use pont_types::proof::{
    ...
    H: CryptoHasher,
{
    ...
    ///
    /// See [`pont_types::proof::AccumulatorProof`] for proof format.
    pub fn get_proof(
        reader: &R,
    ...
    ///
    /// See [`pont_types::proof::AccumulatorConsistencyProof`] for proof format.
    ...
    ///
    /// See [`pont_types::proof::AccumulatorRangeProof`] for proof format.
