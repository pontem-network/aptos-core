...
pub static HEARTBEAT_TS: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "pont_db_backup_coordinator_heartbeat_timestamp_s",
...
pub static EPOCH_ENDING_EPOCH: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "pont_db_backup_coordinator_epoch_ending_epoch",
...
pub static STATE_SNAPSHOT_EPOCH: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "pont_db_backup_coordinator_state_snapshot_epoch",
...
pub static TRANSACTION_VERSION: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "pont_db_backup_coordinator_transaction_version",
