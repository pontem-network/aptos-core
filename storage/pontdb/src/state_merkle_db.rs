...
pub(crate) type LeafNode = pont_jellyfish_merkle::node_type::LeafNode<StateKey>;
pub(crate) type Node = pont_jellyfish_merkle::node_type::Node<StateKey>;
type NodeBatch = pont_jellyfish_merkle::NodeBatch<StateKey>;
