...
pub static COMMITTED_TXNS: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!(
        "pont_storage_committed_txns",
        "Pont storage committed transactions"
    )
    .unwrap()
});
...
pub static LATEST_TXN_VERSION: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "pont_storage_latest_transaction_version",
        "Pont storage latest transaction version"
    )
    .unwrap()
});
...
pub static STATE_ITEMS: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!("pont_storage_state_items", "Total number of state items.").unwrap()
});

pub static TOTAL_STATE_BYTES: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "pont_storage_total_state_bytes",
...
pub static PRUNER_WINDOW: Lazy<IntGaugeVec> = Lazy::new(|| {
    register_int_gauge_vec!(
        // metric name
        "pont_storage_prune_window",
        // metric description
        "Pont storage prune window",
        // metric labels (dimensions)
        &["pruner_name",]
    )
    .unwrap()
...
pub static PRUNER_LEAST_READABLE_VERSION: Lazy<IntGaugeVec> = Lazy::new(|| {
    register_int_gauge_vec!(
        // metric name
        "pont_pruner_min_readable_version",
        // metric description
        "Pont pruner least readable state version",
        // metric labels (dimensions)
        &["pruner_name",]
    )
    .unwrap()
...
pub static API_LATENCY_SECONDS: Lazy<HistogramVec> = Lazy::new(|| {
    register_histogram_vec!(
        // metric name
        "pont_storage_api_latency_seconds",
        // metric description
        "Pont storage api latency in seconds",
        // metric labels (dimensions)
        &["api_name", "result"],
...
pub static OTHER_TIMERS_SECONDS: Lazy<HistogramVec> = Lazy::new(|| {
    register_histogram_vec!(
        // metric name
        "pont_storage_other_timers_seconds",
        // metric description
...
pub static NODE_CACHE_SECONDS: Lazy<HistogramVec> = Lazy::new(|| {
    register_histogram_vec!(
        // metric name
        "pont_storage_node_cache_seconds",
        // metric description
...
pub(crate) static LATEST_SNAPSHOT_VERSION: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "pont_storage_latest_state_snapshot_version",
...
pub(crate) static LATEST_CHECKPOINT_VERSION: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "pont_storage_latest_state_checkpoint_version",
...
pub(crate) static BACKUP_EPOCH_ENDING_EPOCH: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "pont_backup_handler_epoch_ending_epoch",
...
pub(crate) static BACKUP_TXN_VERSION: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "pont_backup_handler_transaction_version",
...
pub(crate) static BACKUP_STATE_SNAPSHOT_VERSION: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "pont_backup_handler_state_snapshot_version",
...
pub(crate) static BACKUP_STATE_SNAPSHOT_LEAF_IDX: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "pont_backup_handler_state_snapshot_leaf_index",
