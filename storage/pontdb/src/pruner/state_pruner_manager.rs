...
use pont_config::config::StateMerklePrunerConfig;
use pont_infallible::Mutex;

use crate::pruner::pruner_manager::PrunerManager;
use pont_jellyfish_merkle::StaleNodeIndex;
...
/// The `Pruner` is meant to be part of a `PontDB` instance and runs in the background to prune old
/// data.
///
