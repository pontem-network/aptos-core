...
//! A model to test properties of common Pont transactions.
//!
//! The structs and functions in this module together form a simplified *model* of how common Pont
...
pub fn txn_one_account_result(
    ...
    // The transactions set the gas cost to 1 micropont.
