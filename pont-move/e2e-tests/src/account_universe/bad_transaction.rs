...
use pont_gas::{FeePerGasUnit, Gas, InitialGasSchedule, TransactionGasParameters};
...
pub struct InvalidAuthkeyGen {
    sender: Index,
    #[proptest(
        strategy = "pont_crypto::test_utils::uniform_keypair_strategy_with_perturbation(1)"
    )]
