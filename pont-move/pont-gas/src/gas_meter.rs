...
pub struct NativeGasParameters {
    ...
    pub pont_framework: framework::natives::GasParameters,
...
impl FromOnChainGasSchedule for NativeGasParameters {
    fn from_on_chain_gas_schedule(gas_schedule: &BTreeMap<String, u64>) -> Option<Self> {
        Some(Self {
            ...
            pont_framework: FromOnChainGasSchedule::from_on_chain_gas_schedule(gas_schedule)?,
...
impl ToOnChainGasSchedule for NativeGasParameters {
    fn to_on_chain_gas_schedule(&self) -> Vec<(String, u64)> {
        ...
        entries.extend(self.pont_framework.to_on_chain_gas_schedule());
...
impl NativeGasParameters {
    pub fn zeros() -> Self {
        Self {
            ...
            pont_framework: framework::natives::GasParameters::zeros(),
...
impl InitialGasSchedule for NativeGasParameters {
    fn initial() -> Self {
        Self {
            ...
            pont_framework: InitialGasSchedule::initial(),
            table: InitialGasSchedule::initial(),
        }
    }
}

/// Gas parameters for everything that is needed to run the Pont blockchain, including
/// instructions, transactions and native functions from various packages.
#[derive(Debug, Clone)]
pub struct PontGasParameters {
...
impl FromOnChainGasSchedule for PontGasParameters {
    fn from_on_chain_gas_schedule(gas_schedule: &BTreeMap<String, u64>) -> Option<Self> {
        Some(Self {
...
impl ToOnChainGasSchedule for PontGasParameters {
    fn to_on_chain_gas_schedule(&self) -> Vec<(String, u64)> {
...
impl InitialGasSchedule for PontGasParameters {
    fn initial() -> Self {
        Self {
...
/// The official gas meter used inside the Pont VM.
...
pub struct PontGasMeter {
    feature_version: u64,
    gas_params: PontGasParameters,
...
impl GasMeter for PontGasMeter {
    #[inline]
