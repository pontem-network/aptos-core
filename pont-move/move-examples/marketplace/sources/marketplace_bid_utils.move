...
module marketplace::marketplace_bid_utils {
    ...
    use pont_token::token::{Self, TokenId};
    ...
    public fun test_aution_setup(
        ...
        account::create_account_for_test(signer::address_of(pont_framework));
        ...
        coin::create_fake_money(pont_framework, bidder_a, 100);
        coin::transfer<coin::FakeMoney>(pont_framework, signer::address_of(bidder_a), 100);
    ...
    #[test(owner = @0xFE, bidder_a = @0xBC, pont_framework = @pont_framework)]
    public fun test_successful(
        ...
        execute_listing_bid(bid_id, entry,@pont_framework, 10, 100);
    ...
    #[test(owner = @0xAF, bidder_a = @0xBB, pont_framework = @pont_framework)]
    ...
    public fun test_wrong_coin_amount(
        ...
        timestamp::update_global_time_for_test(100000000);
        execute_listing_bid(bid_id,  entry, @pont_framework, 0, 1);
    }
    ...
    public fun test_instant_sale_setup(
        ...
        coin::create_fake_money(pont_framework, buyer, 100);
        coin::transfer<coin::FakeMoney>(pont_framework, signer::address_of(buyer), 100);
        //assert!(signer::address_of(&owner) == @0x1, 1);
    ...
    #[test(owner = @0xAF, buyer = @0xBB, framework = @pont_framework, market = @0x33)]
    ...
    #[test(owner = @0x12, buyer = @0x34, framework = @pont_framework)]
    ...
    #[test(owner = @0xAF, bidder_a = @0xBB, framework = @pont_framework, buyer = @0xee)]
