...
/// Check pont/move-e2e-tests/src/tests /mint.nft.rs for an e2e example.
///
...
module mint_nft::minting {
    ...
    use pont_token::token::{Self, TokenDataId};
    use pont_framework::resource_account;
    #[test_only]
    ...
    // signatures generated by running `cargo test sample_mint_nft_signature -- --nocapture` in `pont-core/pont-move/e2e-move-tests`
    #[test_only]
    ...
    #[test_only]
    public fun set_up_test(origin_account: signer, collection_token_minter: &signer, pont_framework: signer, nft_receiver: &signer, timestamp: u64) {
    ...
    #[test (origin_account = @0xcafe, collection_token_minter = @0xc3bb8488ab1a5815a9d543d7e41b0e0df46a7396f89b22821f07a4362f75ddc5, nft_receiver = @0x123, nft_receiver2 = @0x234, pont_framework = @pont_framework)]
    public entry fun test_happy_path(origin_account: signer, collection_token_minter: signer, nft_receiver: signer, nft_receiver2: signer, pont_framework: signer) acquires CollectionTokenMinter {
        set_up_test(origin_account, &collection_token_minter, pont_framework, &nft_receiver, 10);
    ...
    #[test (origin_account = @0xcafe, collection_token_minter = @0xc3bb8488ab1a5815a9d543d7e41b0e0df46a7396f89b22821f07a4362f75ddc5, nft_receiver = @0x123, pont_framework = @pont_framework)]
    #[expected_failure(abort_code = 327682)]
    public entry fun test_minting_expired(origin_account: signer, collection_token_minter: signer, nft_receiver: signer, pont_framework: signer) acquires CollectionTokenMinter {
        set_up_test(origin_account, &collection_token_minter, pont_framework, &nft_receiver, 10000000);
        mint_nft(&nft_receiver, VALID_SIGNATURE);
    }

    #[test (origin_account = @0xcafe, collection_token_minter = @0xc3bb8488ab1a5815a9d543d7e41b0e0df46a7396f89b22821f07a4362f75ddc5, nft_receiver = @0x123, pont_framework = @pont_framework)]
    #[expected_failure(abort_code = 327682)]
    public entry fun test_update_expiration_time(origin_account: signer, collection_token_minter: signer, nft_receiver: signer, pont_framework: signer) acquires CollectionTokenMinter {
        set_up_test(origin_account, &collection_token_minter, pont_framework, &nft_receiver, 10);
    ...
    public entry fun test_update_minting_enabled(origin_account: signer, collection_token_minter: signer, nft_receiver: signer, pont_framework: signer) acquires CollectionTokenMinter {
        set_up_test(origin_account, &collection_token_minter, pont_framework, &nft_receiver, 10);
    ...
    public entry fun test_invalid_signature(origin_account: signer, collection_token_minter: signer, nft_receiver: signer, pont_framework: signer) acquires CollectionTokenMinter {
        set_up_test(origin_account, &collection_token_minter, pont_framework, &nft_receiver, 10);
