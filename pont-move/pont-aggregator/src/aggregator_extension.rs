...
mod test {
    ...
    use pont_types::{
        ...
        state_store::{
            ...
            table::TableHandle as PontTableHandle,
        },
    };
    ...
    impl TableResolver for FakeTestStorage {
        fn resolve_table_entry(
            ...
            let state_key = StateKey::table_item(PontTableHandle::from(*handle), key.to_vec());
    ...
    fn id_to_state_key(id: AggregatorID) -> StateKey {
        StateKey::table_item(PontTableHandle::from(id.handle), id.key.0.to_vec())
    }
