...
fn verify_signature() {
    ...
    let program = pont_stdlib::pont_coin_transfer(*sender.address(), 100);
...
fn verify_simple_payment() {
    ...
    let txn = sender
        .account()
        .transaction()
        .payload(pont_stdlib::pont_coin_transfer(
            *receiver.address(),
            transfer_amount,
        ))
        .sequence_number(10)
...
fn test_module_dependency_fails_verification() {
    ...
    let good_module = {
        ...
        pont_types::transaction::Module::new(serialized_module)
    };
...
fn test_module_transitive_dependency_fails_verification() {
    ...
    let module = {
        ...
        pont_types::transaction::Module::new(
            compiler
