...
use pont_gas::{PontGasMeter, PontGasParameters, StorageGasParameters, LATEST_GAS_FEATURE_VERSION};
...
fn failed_transaction_cleanup_test() {
    ...
    let pont_vm = PontVM::new(executor.get_state_view());
    ...
    let gas_params = PontGasParameters::zeros();
    ...
    let out1 = pont_vm.failed_transaction_cleanup(
    ...
    let out2 = pont_vm.failed_transaction_cleanup(
