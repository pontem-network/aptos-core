...
use pont_vm::{data_cache::AsMoveResolver, parallel_executor::ParallelPontVM, PontVM, VMExecutor};
use proptest::{
    collection::vec,
...
impl TransactionBenchState {
    ...
    fn execute(self) {
        ...
        PontVM::execute_block(self.transactions, self.executor.get_state_view())
