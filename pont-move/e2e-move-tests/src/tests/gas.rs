...
use cached_packages::{pont_stdlib, pont_token_sdk_builder};
use pont_crypto::{bls12381, PrivateKey, Uniform};
use pont_types::account_address::{default_stake_pool_address, AccountAddress};
...
fn test_gas() {
    ...
    print_gas_cost(
        ...
        harness.evaluate_gas(
            account_1,
            pont_stdlib::pont_coin_transfer(account_2_address, 1000),
        ),
    );
    print_gas_cost(
        "CreateAccount",
        harness.evaluate_gas(
            account_1,
            pont_stdlib::pont_account_create_account(
    ...
    print_gas_cost(
        ...
        harness.evaluate_gas(
            account_1,
            pont_stdlib::pont_account_transfer(
    ...
    print_gas_cost(
        ...
        harness.evaluate_gas(
            account_1,
            pont_token_sdk_builder::token_create_collection_script(
    ...
    print_gas_cost(
        ...
        harness.evaluate_gas(
            account_1,
            pont_token_sdk_builder::token_create_token_script(
                collection_name.clone(),
                token_name.clone(),
    ...
    print_gas_cost(
        ...
        harness.evaluate_gas(
            account_1,
            pont_token_sdk_builder::token_mint_script(
                account_1_address,
                collection_name.clone(),
                token_name.clone(),
                1,
    ...
    print_gas_cost(
        ...
        harness.evaluate_gas(
            account_1,
            pont_token_sdk_builder::token_mutate_token_properties(
                account_1_address,
                account_1_address,
                collection_name,
                token_name,
    ...
    let publisher = &harness.pont_framework_account();
    print_gas_cost(
        "PublishLarge",
        harness.evaluate_publish_gas(
            publisher,
