...
use pont_types::account_config::CoinStoreResource;
use pont_types::{
...
const APTOS_COIN_STRUCT_STRING: &str = "0x1::coin::CoinStore<0x1::pont_coin::PontCoin>";
...
fn exchange_e2e_test() {
    ...
    let result = h.run_transaction_payload(
        &origin_account,
        pont_stdlib::resource_account_create_resource_account_and_publish_package(
            vec![],
    ...
    // swap from 5 pont coins to 5 chloe's coins
    ...
    // swap to 3 pont coins from 3 chloe's pont coins
