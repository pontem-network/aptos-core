...
module pont_std::bls12381 {
    ...
    /// Random signature generated by running `cargo test -- bls12381_sample_signature --nocapture --include-ignored` in `crates/pont-crypto`.
    /// The message signed is "Hello Pont!" and the associated SK is 07416693b6b32c84abe45578728e2379f525729e5b94762435a31e65ecc728da.
    ...
    fun test_pubkey_aggregation() {
        // Second, try some test-cases generated by running the following command in `crates/pont-crypto`:
    ...
    fun test_verify_aggsig() {
        ...
        // The signed messages are "Hello, Pont <i>!", where <i> \in {1, ..., 5}
        let msgs = vector[
    ...
    fun test_verify_pop() {
        // Test case generated by running `cargo test -- sample_pop --nocapture --include-ignored` in `crates/pont-crypto`
        // =============================================================================================================
