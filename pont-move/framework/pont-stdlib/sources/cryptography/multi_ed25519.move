...
module pont_std::multi_ed25519 {
    ...
    /// The identifier of the MultiEd25519 signature scheme, which is used when deriving Pont authentication keys by hashing
    ...
    /// Derives the Pont-specific authentication key of the given Ed25519 public key.
