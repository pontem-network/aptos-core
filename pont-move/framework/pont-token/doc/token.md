...
Checkout our developer doc on our token standard https://pont.dev/concepts/coin-and-token/pont-token
...
<pre><code><b>use</b> <a href="../../pont-framework/doc/account.md#0x1_account">0x1::account</a>;
<b>use</b> <a href="../../move-stdlib/doc/error.md#0x1_error">0x1::error</a>;
<b>use</b> <a href="../../pont-framework/doc/event.md#0x1_event">0x1::event</a>;
<b>use</b> <a href="../../move-stdlib/doc/option.md#0x1_option">0x1::option</a>;
<b>use</b> <a href="../../move-stdlib/doc/signer.md#0x1_signer">0x1::signer</a>;
<b>use</b> <a href="../../move-stdlib/doc/string.md#0x1_string">0x1::string</a>;
<b>use</b> <a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table">0x1::table</a>;
<b>use</b> <a href="../../pont-framework/doc/timestamp.md#0x1_timestamp">0x1::timestamp</a>;
...
<dl>
<dt>
<code>tokens: <a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_Table">table::Table</a>&lt;<a href="token.md#0x3_token_TokenId">token::TokenId</a>, <a href="token.md#0x3_token_Token">token::Token</a>&gt;</code>
</dt>
<dd>
...
<dt>
<code>deposit_events: <a href="../../pont-framework/doc/event.md#0x1_event_EventHandle">event::EventHandle</a>&lt;<a href="token.md#0x3_token_DepositEvent">token::DepositEvent</a>&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>withdraw_events: <a href="../../pont-framework/doc/event.md#0x1_event_EventHandle">event::EventHandle</a>&lt;<a href="token.md#0x3_token_WithdrawEvent">token::WithdrawEvent</a>&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>burn_events: <a href="../../pont-framework/doc/event.md#0x1_event_EventHandle">event::EventHandle</a>&lt;<a href="token.md#0x3_token_BurnTokenEvent">token::BurnTokenEvent</a>&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>mutate_token_property_events: <a href="../../pont-framework/doc/event.md#0x1_event_EventHandle">event::EventHandle</a>&lt;<a href="token.md#0x3_token_MutateTokenPropertyMapEvent">token::MutateTokenPropertyMapEvent</a>&gt;</code>
</dt>
<dd>
...
<dl>
<dt>
<code>collection_data: <a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_Table">table::Table</a>&lt;<a href="../../move-stdlib/doc/string.md#0x1_string_String">string::String</a>, <a href="token.md#0x3_token_CollectionData">token::CollectionData</a>&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>token_data: <a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_Table">table::Table</a>&lt;<a href="token.md#0x3_token_TokenDataId">token::TokenDataId</a>, <a href="token.md#0x3_token_TokenData">token::TokenData</a>&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>create_collection_events: <a href="../../pont-framework/doc/event.md#0x1_event_EventHandle">event::EventHandle</a>&lt;<a href="token.md#0x3_token_CreateCollectionEvent">token::CreateCollectionEvent</a>&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>create_token_data_events: <a href="../../pont-framework/doc/event.md#0x1_event_EventHandle">event::EventHandle</a>&lt;<a href="token.md#0x3_token_CreateTokenDataEvent">token::CreateTokenDataEvent</a>&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>mint_token_events: <a href="../../pont-framework/doc/event.md#0x1_event_EventHandle">event::EventHandle</a>&lt;<a href="token.md#0x3_token_MintTokenEvent">token::MintTokenEvent</a>&gt;</code>
</dt>
<dd>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="token.md#0x3_token_create_token_script">create_token_script</a>(
    <a href="../../pont-framework/doc/account.md#0x1_account">account</a>: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>,
    collection: String,
    name: String,
    description: String,
    balance: u64,
    ...
    <b>let</b> tokendata_id = <a href="token.md#0x3_token_create_tokendata">create_tokendata</a>(
        <a href="../../pont-framework/doc/account.md#0x1_account">account</a>,
        collection,
        name,
        description,
        maximum,
...
<pre><code><b>public</b> entry <b>fun</b> <a href="token.md#0x3_token_mutate_token_properties">mutate_token_properties</a>(
    ...
    <b>assert</b>!(<a href="../../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(<a href="../../pont-framework/doc/account.md#0x1_account">account</a>) == creator, <a href="../../move-stdlib/doc/error.md#0x1_error_not_found">error::not_found</a>(<a href="token.md#0x3_token_ENO_MUTATE_CAPABILITY">ENO_MUTATE_CAPABILITY</a>));
    <b>let</b> i = 0;
    ...
    <b>while</b> (i &lt; amount) {
        <a href="token.md#0x3_token_mutate_one_token">mutate_one_token</a>(<a href="../../pont-framework/doc/account.md#0x1_account">account</a>, token_owner, token_id, keys, values, types);
        i = i + 1;
    };
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="token.md#0x3_token_opt_in_direct_transfer">opt_in_direct_transfer</a>(<a href="../../pont-framework/doc/account.md#0x1_account">account</a>: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, opt_in: bool)
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="token.md#0x3_token_opt_in_direct_transfer">opt_in_direct_transfer</a>(<a href="../../pont-framework/doc/account.md#0x1_account">account</a>: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, opt_in: bool) <b>acquires</b> <a href="token.md#0x3_token_TokenStore">TokenStore</a> {
    <b>let</b> addr = <a href="../../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(<a href="../../pont-framework/doc/account.md#0x1_account">account</a>);
    <a href="token.md#0x3_token_initialize_token_store">initialize_token_store</a>(<a href="../../pont-framework/doc/account.md#0x1_account">account</a>);
...
<pre><code><b>public</b> entry <b>fun</b> <a href="token.md#0x3_token_burn_by_creator">burn_by_creator</a>(
    ...
    <b>assert</b>!(
        <a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_contains">table::contains</a>(&collections.token_data, token_id.token_data_id),
    ...
    <b>let</b> token_data = <a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_borrow_mut">table::borrow_mut</a>(
    ...
    <a href="../../pont-framework/doc/event.md#0x1_event_emit_event">event::emit_event</a>&lt;<a href="token.md#0x3_token_BurnTokenEvent">BurnTokenEvent</a>&gt;(
    ...
    <b>if</b> (token_data.maximum &gt; 0) {
        ...
        <b>if</b> (token_data.supply == 0) {
            <a href="token.md#0x3_token_destroy_token_data">destroy_token_data</a>(<a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_remove">table::remove</a>(&<b>mut</b> collections.token_data, token_id.token_data_id));

            // <b>update</b> the collection supply
            <b>let</b> collection_data = <a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_borrow_mut">table::borrow_mut</a>(
            ...
            <b>if</b> (collection_data.supply == 0) {
                <a href="token.md#0x3_token_destroy_collection_data">destroy_collection_data</a>(<a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_remove">table::remove</a>(&<b>mut</b> collections.collection_data, collection_data.name));
            };
        };
    };
}
...
<pre><code><b>public</b> <b>fun</b> <a href="token.md#0x3_token_mutate_one_token">mutate_one_token</a>(
    ...
    <b>assert</b>!(<a href="../../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(<a href="../../pont-framework/doc/account.md#0x1_account">account</a>) == creator, <a href="token.md#0x3_token_ENO_MUTATE_CAPABILITY">ENO_MUTATE_CAPABILITY</a>);
    ...
    <b>assert</b>!(<a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_contains">table::contains</a>(all_token_data, token_id.token_data_id), <a href="../../move-stdlib/doc/error.md#0x1_error_not_found">error::not_found</a>(<a href="token.md#0x3_token_ETOKEN_DATA_NOT_PUBLISHED">ETOKEN_DATA_NOT_PUBLISHED</a>));
    <b>let</b> token_data = <a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_borrow_mut">table::borrow_mut</a>(all_token_data, token_id.token_data_id);
    ...
    <b>if</b> (token_id.property_version == 0) {
        ...
        <a href="../../pont-framework/doc/event.md#0x1_event_emit_event">event::emit_event</a>&lt;<a href="token.md#0x3_token_MutateTokenPropertyMapEvent">MutateTokenPropertyMapEvent</a>&gt;(
...
<pre><code><b>public</b> <b>fun</b> <a href="token.md#0x3_token_create_royalty">create_royalty</a>(royalty_points_numerator: u64, royalty_points_denominator: u64, payee_address: <b>address</b>): <a href="token.md#0x3_token_Royalty">Royalty</a> {
    <b>assert</b>!(royalty_points_denominator &gt; 0, <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="token.md#0x3_token_EINVALID_ROYALTY_NUMERATOR_DENOMINATOR">EINVALID_ROYALTY_NUMERATOR_DENOMINATOR</a>));
    ...
    <b>assert</b>!(<a href="../../pont-framework/doc/account.md#0x1_account_exists_at">account::exists_at</a>(payee_address), <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="token.md#0x3_token_EROYALTY_PAYEE_ACCOUNT_DOES_NOT_EXIST">EROYALTY_PAYEE_ACCOUNT_DOES_NOT_EXIST</a>));
...
<pre><code><b>fun</b> <a href="token.md#0x3_token_assert_tokendata_exists">assert_tokendata_exists</a>(creator: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, token_data_id: <a href="token.md#0x3_token_TokenDataId">TokenDataId</a>) <b>acquires</b> <a href="token.md#0x3_token_Collections">Collections</a> {
    ...
    <b>assert</b>!(<a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_contains">table::contains</a>(all_token_data, token_data_id), <a href="../../move-stdlib/doc/error.md#0x1_error_not_found">error::not_found</a>(<a href="token.md#0x3_token_ETOKEN_DATA_NOT_PUBLISHED">ETOKEN_DATA_NOT_PUBLISHED</a>));
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="token.md#0x3_token_mutate_tokendata_maximum">mutate_tokendata_maximum</a>(creator: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, token_data_id: <a href="token.md#0x3_token_TokenDataId">TokenDataId</a>, maximum: u64) <b>acquires</b> <a href="token.md#0x3_token_Collections">Collections</a> {
    ...
    <b>let</b> token_data = <a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_borrow_mut">table::borrow_mut</a>(all_token_data, token_data_id);
...
<pre><code><b>public</b> <b>fun</b> <a href="token.md#0x3_token_deposit_token">deposit_token</a>(<a href="../../pont-framework/doc/account.md#0x1_account">account</a>: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, <a href="token.md#0x3_token">token</a>: <a href="token.md#0x3_token_Token">token::Token</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="token.md#0x3_token_deposit_token">deposit_token</a>(<a href="../../pont-framework/doc/account.md#0x1_account">account</a>: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, <a href="token.md#0x3_token">token</a>: <a href="token.md#0x3_token_Token">Token</a>) <b>acquires</b> <a href="token.md#0x3_token_TokenStore">TokenStore</a> {
    <b>let</b> account_addr = <a href="../../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(<a href="../../pont-framework/doc/account.md#0x1_account">account</a>);
    <a href="token.md#0x3_token_initialize_token_store">initialize_token_store</a>(<a href="../../pont-framework/doc/account.md#0x1_account">account</a>);
...
<pre><code><b>public</b> <b>fun</b> <a href="token.md#0x3_token_initialize_token_store">initialize_token_store</a>(<a href="../../pont-framework/doc/account.md#0x1_account">account</a>: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="token.md#0x3_token_initialize_token_store">initialize_token_store</a>(<a href="../../pont-framework/doc/account.md#0x1_account">account</a>: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>) {
    <b>if</b> (!<b>exists</b>&lt;<a href="token.md#0x3_token_TokenStore">TokenStore</a>&gt;(<a href="../../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(<a href="../../pont-framework/doc/account.md#0x1_account">account</a>))) {
        <b>move_to</b>(
            <a href="../../pont-framework/doc/account.md#0x1_account">account</a>,
            <a href="token.md#0x3_token_TokenStore">TokenStore</a> {
                tokens: <a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_new">table::new</a>(),
                direct_transfer: <b>false</b>,
                deposit_events: <a href="../../pont-framework/doc/account.md#0x1_account_new_event_handle">account::new_event_handle</a>&lt;<a href="token.md#0x3_token_DepositEvent">DepositEvent</a>&gt;(<a href="../../pont-framework/doc/account.md#0x1_account">account</a>),
                withdraw_events: <a href="../../pont-framework/doc/account.md#0x1_account_new_event_handle">account::new_event_handle</a>&lt;<a href="token.md#0x3_token_WithdrawEvent">WithdrawEvent</a>&gt;(<a href="../../pont-framework/doc/account.md#0x1_account">account</a>),
                burn_events: <a href="../../pont-framework/doc/account.md#0x1_account_new_event_handle">account::new_event_handle</a>&lt;<a href="token.md#0x3_token_BurnTokenEvent">BurnTokenEvent</a>&gt;(<a href="../../pont-framework/doc/account.md#0x1_account">account</a>),
                mutate_token_property_events: <a href="../../pont-framework/doc/account.md#0x1_account_new_event_handle">account::new_event_handle</a>&lt;<a href="token.md#0x3_token_MutateTokenPropertyMapEvent">MutateTokenPropertyMapEvent</a>&gt;(<a href="../../pont-framework/doc/account.md#0x1_account">account</a>),
            },
        );
    }
}
...
<pre><code><b>public</b> <b>fun</b> <a href="token.md#0x3_token_withdraw_with_capability">withdraw_with_capability</a>(
    ...
    <b>assert</b>!(<a href="../../pont-framework/doc/timestamp.md#0x1_timestamp_now_seconds">timestamp::now_seconds</a>() &lt;= *&withdraw_proof.expiration_sec, <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="token.md#0x3_token_EWITHDRAW_PROOF_EXPIRES">EWITHDRAW_PROOF_EXPIRES</a>));
...
<pre><code><b>public</b> <b>fun</b> <a href="token.md#0x3_token_withdraw_token">withdraw_token</a>(<a href="../../pont-framework/doc/account.md#0x1_account">account</a>: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, id: <a href="token.md#0x3_token_TokenId">token::TokenId</a>, amount: u64): <a href="token.md#0x3_token_Token">token::Token</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="token.md#0x3_token_create_collection">create_collection</a>(
    ...
    <b>if</b> (!<b>exists</b>&lt;<a href="token.md#0x3_token_Collections">Collections</a>&gt;(account_addr)) {
        <b>move_to</b>(
            ...
            <a href="token.md#0x3_token_Collections">Collections</a> {
                collection_data: <a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_new">table::new</a>(),
                token_data: <a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_new">table::new</a>(),
                create_collection_events: <a href="../../pont-framework/doc/account.md#0x1_account_new_event_handle">account::new_event_handle</a>&lt;<a href="token.md#0x3_token_CreateCollectionEvent">CreateCollectionEvent</a>&gt;(creator),
                create_token_data_events: <a href="../../pont-framework/doc/account.md#0x1_account_new_event_handle">account::new_event_handle</a>&lt;<a href="token.md#0x3_token_CreateTokenDataEvent">CreateTokenDataEvent</a>&gt;(creator),
                mint_token_events: <a href="../../pont-framework/doc/account.md#0x1_account_new_event_handle">account::new_event_handle</a>&lt;<a href="token.md#0x3_token_MintTokenEvent">MintTokenEvent</a>&gt;(creator),
            },
        )
    };
    ...
    <b>assert</b>!(
        !<a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_contains">table::contains</a>(collection_data, name),
    ...
    <a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_add">table::add</a>(collection_data, name, collection);
    <b>let</b> collection_handle = <b>borrow_global_mut</b>&lt;<a href="token.md#0x3_token_Collections">Collections</a>&gt;(account_addr);
    <a href="../../pont-framework/doc/event.md#0x1_event_emit_event">event::emit_event</a>&lt;<a href="token.md#0x3_token_CreateCollectionEvent">CreateCollectionEvent</a>&gt;(
...
<pre><code><b>public</b> <b>fun</b> <a href="token.md#0x3_token_check_tokendata_exists">check_tokendata_exists</a>(creator: <b>address</b>, collection_name: String, token_name: String): bool <b>acquires</b> <a href="token.md#0x3_token_Collections">Collections</a> {
    ...
    <a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_contains">table::contains</a>(token_data, token_data_id)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="token.md#0x3_token_create_tokendata">create_tokendata</a>(
    ...
    <b>assert</b>!(
        <a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_contains">table::contains</a>(&collections.collection_data, token_data_id.collection),
    ...
    <b>assert</b>!(
        !<a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_contains">table::contains</a>(&collections.token_data, token_data_id),
    ...
    <b>let</b> collection = <a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_borrow_mut">table::borrow_mut</a>(&<b>mut</b> collections.collection_data, token_data_id.collection);
    ...
    <a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_add">table::add</a>(&<b>mut</b> collections.token_data, token_data_id, token_data);

    <a href="../../pont-framework/doc/event.md#0x1_event_emit_event">event::emit_event</a>&lt;<a href="token.md#0x3_token_CreateTokenDataEvent">CreateTokenDataEvent</a>&gt;(
...
<pre><code><b>public</b> <b>fun</b> <a href="token.md#0x3_token_get_collection_supply">get_collection_supply</a>(creator_address: <b>address</b>, collection_name: String): Option&lt;u64&gt; <b>acquires</b> <a href="token.md#0x3_token_Collections">Collections</a> {
    ...
    <b>assert</b>!(<a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_contains">table::contains</a>(collections, collection_name), <a href="../../move-stdlib/doc/error.md#0x1_error_not_found">error::not_found</a>(<a href="token.md#0x3_token_ECOLLECTION_NOT_PUBLISHED">ECOLLECTION_NOT_PUBLISHED</a>));
    <b>let</b> collection_data = <a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_borrow">table::borrow</a>(collections, collection_name);
...
<pre><code><b>public</b> <b>fun</b> <a href="token.md#0x3_token_get_token_supply">get_token_supply</a>(creator_address: <b>address</b>, token_data_id: <a href="token.md#0x3_token_TokenDataId">TokenDataId</a>): Option&lt;u64&gt; <b>acquires</b> <a href="token.md#0x3_token_Collections">Collections</a> {
    ...
    <b>assert</b>!(<a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_contains">table::contains</a>(all_token_data, token_data_id), <a href="../../move-stdlib/doc/error.md#0x1_error_not_found">error::not_found</a>(<a href="token.md#0x3_token_ETOKEN_DATA_NOT_PUBLISHED">ETOKEN_DATA_NOT_PUBLISHED</a>));
    <b>let</b> token_data = <a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_borrow">table::borrow</a>(all_token_data, token_data_id);
...
<pre><code><b>public</b> <b>fun</b> <a href="token.md#0x3_token_get_tokendata_largest_property_version">get_tokendata_largest_property_version</a>(creator_address: <b>address</b>, token_data_id: <a href="token.md#0x3_token_TokenDataId">TokenDataId</a>): u64 <b>acquires</b> <a href="token.md#0x3_token_Collections">Collections</a> {
    ...
    <b>let</b> all_token_data = &<b>borrow_global</b>&lt;<a href="token.md#0x3_token_Collections">Collections</a>&gt;(creator_address).token_data;
    <b>assert</b>!(<a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_contains">table::contains</a>(all_token_data, token_data_id), <a href="../../move-stdlib/doc/error.md#0x1_error_not_found">error::not_found</a>(<a href="token.md#0x3_token_ETOKEN_DATA_NOT_PUBLISHED">ETOKEN_DATA_NOT_PUBLISHED</a>));
    <a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_borrow">table::borrow</a>(all_token_data, token_data_id).largest_property_version
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="token.md#0x3_token_mint_token">mint_token</a>(
    ...
    <a href="token.md#0x3_token_deposit_token">deposit_token</a>(<a href="../../pont-framework/doc/account.md#0x1_account">account</a>,
        <a href="token.md#0x3_token_Token">Token</a> {
            id: token_id,
            amount,
    ...
    <a href="../../pont-framework/doc/event.md#0x1_event_emit_event">event::emit_event</a>&lt;<a href="token.md#0x3_token_MintTokenEvent">MintTokenEvent</a>&gt;(
...
<pre><code><b>public</b> <b>fun</b> <a href="token.md#0x3_token_mint_token_to">mint_token_to</a>(<a href="../../pont-framework/doc/account.md#0x1_account">account</a>: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, receiver: <b>address</b>, token_data_id: <a href="token.md#0x3_token_TokenDataId">token::TokenDataId</a>, amount: u64)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="token.md#0x3_token_balance_of">balance_of</a>(owner: <b>address</b>, id: <a href="token.md#0x3_token_TokenId">TokenId</a>): u64 <b>acquires</b> <a href="token.md#0x3_token_TokenStore">TokenStore</a> {
    ...
    <b>if</b> (<a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_contains">table::contains</a>(&token_store.tokens, id)) {
        <a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_borrow">table::borrow</a>(&token_store.tokens, id).amount
    } <b>else</b> {
        0
    }
}
...
<pre><code><b>public</b> <b>fun</b> <a href="token.md#0x3_token_get_property_map">get_property_map</a>(owner: <b>address</b>, token_id: <a href="token.md#0x3_token_TokenId">TokenId</a>): PropertyMap <b>acquires</b> <a href="token.md#0x3_token_Collections">Collections</a>, <a href="token.md#0x3_token_TokenStore">TokenStore</a> {
    ...
    <b>if</b> (token_id.property_version == 0) {
        ...
        <b>assert</b>!(<a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_contains">table::contains</a>(all_token_data, token_id.token_data_id), <a href="../../move-stdlib/doc/error.md#0x1_error_not_found">error::not_found</a>(<a href="token.md#0x3_token_ETOKEN_DATA_NOT_PUBLISHED">ETOKEN_DATA_NOT_PUBLISHED</a>));
        <b>let</b> token_data = <a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_borrow">table::borrow</a>(all_token_data, token_id.token_data_id);
        ...
        *&<a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_borrow">table::borrow</a>(tokens, token_id).token_properties
    }
}
</code></pre>
...
<pre><code><b>fun</b> <a href="token.md#0x3_token_withdraw_with_event_internal">withdraw_with_event_internal</a>(
    ...
    // Make sure the <a href="../../pont-framework/doc/account.md#0x1_account">account</a> <b>has</b> sufficient tokens <b>to</b> withdraw.
    ...
    <a href="../../pont-framework/doc/event.md#0x1_event_emit_event">event::emit_event</a>&lt;<a href="token.md#0x3_token_WithdrawEvent">WithdrawEvent</a>&gt;(
    ...
    <b>assert</b>!(
        <a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_contains">table::contains</a>(tokens, id),
    ...
    <b>let</b> balance = &<b>mut</b> <a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_borrow_mut">table::borrow_mut</a>(tokens, id).amount;
    <b>if</b> (*balance &gt; amount) {
        *balance = *balance - amount;
        ...
        <a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_remove">table::remove</a>(tokens, id)
    }
}
</code></pre>
...
<pre><code><b>fun</b> <a href="token.md#0x3_token_update_token_property_internal">update_token_property_internal</a>(
    ...
    <b>assert</b>!(<a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_contains">table::contains</a>(tokens, token_id), <a href="../../move-stdlib/doc/error.md#0x1_error_not_found">error::not_found</a>(<a href="token.md#0x3_token_ENO_TOKEN_IN_TOKEN_STORE">ENO_TOKEN_IN_TOKEN_STORE</a>));

    <b>let</b> value = &<b>mut</b> <a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_borrow_mut">table::borrow_mut</a>(tokens, token_id).token_properties;
...
<pre><code><b>fun</b> <a href="token.md#0x3_token_direct_deposit">direct_deposit</a>(account_addr: <b>address</b>, <a href="token.md#0x3_token">token</a>: <a href="token.md#0x3_token_Token">Token</a>) <b>acquires</b> <a href="token.md#0x3_token_TokenStore">TokenStore</a> {
    ...
    <a href="../../pont-framework/doc/event.md#0x1_event_emit_event">event::emit_event</a>&lt;<a href="token.md#0x3_token_DepositEvent">DepositEvent</a>&gt;(
    ...
    <b>if</b> (!<a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_contains">table::contains</a>(&token_store.tokens, <a href="token.md#0x3_token">token</a>.id)) {
        <a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_add">table::add</a>(&<b>mut</b> token_store.tokens, <a href="token.md#0x3_token">token</a>.id, <a href="token.md#0x3_token">token</a>);
    } <b>else</b> {
        <b>let</b> recipient_token = <a href="../../pont-framework/../pont-stdlib/doc/table.md#0x1_table_borrow_mut">table::borrow_mut</a>(&<b>mut</b> token_store.tokens, <a href="token.md#0x3_token">token</a>.id);
...
<pre><code><b>public</b> <b>fun</b> <a href="token.md#0x3_token_initialize_token_script">initialize_token_script</a>(_account: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>)
</code></pre>
