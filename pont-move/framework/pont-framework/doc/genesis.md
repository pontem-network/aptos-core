...
-  [Function `initialize_pont_coin`](#0x1_genesis_initialize_pont_coin)
-  [Function `initialize_core_resources_and_pont_coin`](#0x1_genesis_initialize_core_resources_and_pont_coin)
...
<b>use</b> <a href="pont_governance.md#0x1_pont_governance">0x1::pont_governance</a>;
...
Genesis step 1: Initialize pont framework account and core modules on chain.
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_initialize">initialize</a>(
    ...
    // Initialize the pont framework <a href="account.md#0x1_account">account</a>. This is the <a href="account.md#0x1_account">account</a> <b>where</b> system resources and modules will be
    ...
    <b>let</b> (pont_framework_account, pont_framework_signer_cap) = <a href="account.md#0x1_account_create_framework_reserved_account">account::create_framework_reserved_account</a>(@pont_framework);
    // Initialize <a href="account.md#0x1_account">account</a> configs on pont framework <a href="account.md#0x1_account">account</a>.
    <a href="account.md#0x1_account_initialize">account::initialize</a>(&pont_framework_account);

    <a href="transaction_validation.md#0x1_transaction_validation_initialize">transaction_validation::initialize</a>(
        &pont_framework_account,
        b"script_prologue",
        b"module_prologue",
    ...
    <a href="pont_governance.md#0x1_pont_governance_store_signer_cap">pont_governance::store_signer_cap</a>(&pont_framework_account, @pont_framework, pont_framework_signer_cap);

    // put reserved framework reserved accounts under pont governance
    ...
    <b>while</b> (!<a href="../../move-stdlib/doc/vector.md#0x1_vector_is_empty">vector::is_empty</a>(&framework_reserved_addresses)) {
        ...
        <b>let</b> (<a href="pont_account.md#0x1_pont_account">pont_account</a>, framework_signer_cap) = <a href="account.md#0x1_account_create_framework_reserved_account">account::create_framework_reserved_account</a>(<b>address</b>);
        <a href="pont_governance.md#0x1_pont_governance_store_signer_cap">pont_governance::store_signer_cap</a>(&<a href="pont_account.md#0x1_pont_account">pont_account</a>, <b>address</b>, framework_signer_cap);
    };

    <a href="consensus_config.md#0x1_consensus_config_initialize">consensus_config::initialize</a>(&pont_framework_account, <a href="consensus_config.md#0x1_consensus_config">consensus_config</a>);
    <a href="version.md#0x1_version_initialize">version::initialize</a>(&pont_framework_account, initial_version);
    <a href="stake.md#0x1_stake_initialize">stake::initialize</a>(&pont_framework_account);
    ...
    <a href="storage_gas.md#0x1_storage_gas_initialize">storage_gas::initialize</a>(&pont_framework_account);
    <a href="gas_schedule.md#0x1_gas_schedule_initialize">gas_schedule::initialize</a>(&pont_framework_account, <a href="gas_schedule.md#0x1_gas_schedule">gas_schedule</a>);

    // Ensure we can create aggregators for supply, but not enable it for common <b>use</b> just yet.
    <a href="aggregator_factory.md#0x1_aggregator_factory_initialize_aggregator_factory">aggregator_factory::initialize_aggregator_factory</a>(&pont_framework_account);
    <a href="coin.md#0x1_coin_initialize_supply_config">coin::initialize_supply_config</a>(&pont_framework_account);

    <a href="chain_id.md#0x1_chain_id_initialize">chain_id::initialize</a>(&pont_framework_account, <a href="chain_id.md#0x1_chain_id">chain_id</a>);
    <a href="reconfiguration.md#0x1_reconfiguration_initialize">reconfiguration::initialize</a>(&pont_framework_account);
    <a href="block.md#0x1_block_initialize">block::initialize</a>(&pont_framework_account, epoch_interval_microsecs);
    <a href="state_storage.md#0x1_state_storage_initialize">state_storage::initialize</a>(&pont_framework_account);
    <a href="timestamp.md#0x1_timestamp_set_time_has_started">timestamp::set_time_has_started</a>(&pont_framework_account);
}
</code></pre>
...
<a name="0x1_genesis_initialize_pont_coin"></a>

## Function `initialize_pont_coin`

Genesis step 2: Initialize Pont coin.


<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_initialize_pont_coin">initialize_pont_coin</a>(pont_framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>)
</code></pre>
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_initialize_pont_coin">initialize_pont_coin</a>(pont_framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>) {
    <b>let</b> (burn_cap, mint_cap) = <a href="pont_coin.md#0x1_pont_coin_initialize">pont_coin::initialize</a>(pont_framework);
    // Give <a href="stake.md#0x1_stake">stake</a> <b>module</b> MintCapability&lt;PontCoin&gt; so it can mint rewards.
    <a href="stake.md#0x1_stake_store_pont_coin_mint_cap">stake::store_pont_coin_mint_cap</a>(pont_framework, mint_cap);
    // Give <a href="transaction_fee.md#0x1_transaction_fee">transaction_fee</a> <b>module</b> BurnCapability&lt;PontCoin&gt; so it can burn gas.
    <a href="transaction_fee.md#0x1_transaction_fee_store_pont_coin_burn_cap">transaction_fee::store_pont_coin_burn_cap</a>(pont_framework, burn_cap);
}
</code></pre>
...
<a name="0x1_genesis_initialize_core_resources_and_pont_coin"></a>

## Function `initialize_core_resources_and_pont_coin`

Only called for testnets and e2e tests.


<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_initialize_core_resources_and_pont_coin">initialize_core_resources_and_pont_coin</a>(pont_framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, core_resources_auth_key: <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;)
</code></pre>
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_initialize_core_resources_and_pont_coin">initialize_core_resources_and_pont_coin</a>(
    ...
    <a href="pont_coin.md#0x1_pont_coin_configure_accounts_for_test">pont_coin::configure_accounts_for_test</a>(pont_framework, &core_resources, mint_cap);
}
</code></pre>
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_create_accounts">create_accounts</a>(pont_framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, accounts: <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="genesis.md#0x1_genesis_AccountMap">genesis::AccountMap</a>&gt;)
</code></pre>
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_create_accounts">create_accounts</a>(pont_framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, accounts: <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="genesis.md#0x1_genesis_AccountMap">AccountMap</a>&gt;) {
    <b>let</b> i = 0;
    <b>let</b> num_accounts = <a href="../../move-stdlib/doc/vector.md#0x1_vector_length">vector::length</a>(&accounts);
    <b>let</b> unique_accounts = <a href="../../move-stdlib/doc/vector.md#0x1_vector_empty">vector::empty</a>();

    <b>while</b> (i &lt; num_accounts) {
        <b>let</b> account_map = <a href="../../move-stdlib/doc/vector.md#0x1_vector_borrow">vector::borrow</a>(&accounts, i);
        <b>assert</b>!(
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_create_account">create_account</a>(pont_framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, account_address: <b>address</b>, balance: u64): <a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>
</code></pre>
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_create_account">create_account</a>(pont_framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, account_address: <b>address</b>, balance: u64): <a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a> {
    <b>if</b> (<a href="account.md#0x1_account_exists_at">account::exists_at</a>(account_address)) {
        ...
        <a href="coin.md#0x1_coin_register">coin::register</a>&lt;PontCoin&gt;(&<a href="account.md#0x1_account">account</a>);
        <a href="pont_coin.md#0x1_pont_coin_mint">pont_coin::mint</a>(pont_framework, account_address, balance);
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_create_employee_validators">create_employee_validators</a>(
    ...
    <b>let</b> i = 0;
    <b>let</b> num_employee_groups = <a href="../../move-stdlib/doc/vector.md#0x1_vector_length">vector::length</a>(&employees);
    <b>let</b> unique_accounts = <a href="../../move-stdlib/doc/vector.md#0x1_vector_empty">vector::empty</a>();

    <b>while</b> (i &lt; num_employee_groups) {
        <b>let</b> j = 0;
        <b>let</b> employee_group = <a href="../../move-stdlib/doc/vector.md#0x1_vector_borrow">vector::borrow</a>(&employees, i);
        ...
        <b>let</b> buy_ins = <a href="../../pont-stdlib/doc/simple_map.md#0x1_simple_map_create">simple_map::create</a>();
        ...
        <b>while</b> (j &lt; num_employees_in_group) {
            ...
            <b>let</b> total = <a href="coin.md#0x1_coin_balance">coin::balance</a>&lt;PontCoin&gt;(*<a href="account.md#0x1_account">account</a>);
            <b>let</b> coins = <a href="coin.md#0x1_coin_withdraw">coin::withdraw</a>&lt;PontCoin&gt;(&employee, total);
            <a href="../../pont-stdlib/doc/simple_map.md#0x1_simple_map_add">simple_map::add</a>(&<b>mut</b> buy_ins, *<a href="account.md#0x1_account">account</a>, coins);
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_create_initialize_validators_with_commission">create_initialize_validators_with_commission</a>(
    ...
    <b>let</b> i = 0;
    <b>let</b> num_validators = <a href="../../move-stdlib/doc/vector.md#0x1_vector_length">vector::length</a>(&validators);
    <b>while</b> (i &lt; num_validators) {
        ...
        <a href="genesis.md#0x1_genesis_create_initialize_validator">create_initialize_validator</a>(pont_framework, validator, use_staking_contract);

        i = i + 1;
    };

    // Destroy the pont framework <a href="account.md#0x1_account">account</a>'s ability <b>to</b> mint coins now that we're done <b>with</b> setting up the initial
    // validators.
    <a href="pont_coin.md#0x1_pont_coin_destroy_mint_cap">pont_coin::destroy_mint_cap</a>(pont_framework);
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_create_initialize_validators">create_initialize_validators</a>(pont_framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, validators: <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="genesis.md#0x1_genesis_ValidatorConfiguration">ValidatorConfiguration</a>&gt;) {
    ...
    <b>while</b> (i &lt; num_validators) {
        <b>let</b> validator_with_commission = <a href="genesis.md#0x1_genesis_ValidatorConfigurationWithCommission">ValidatorConfigurationWithCommission</a> {
            validator_config: <a href="../../move-stdlib/doc/vector.md#0x1_vector_pop_back">vector::pop_back</a>(&<b>mut</b> validators),
    ...
    <a href="genesis.md#0x1_genesis_create_initialize_validators_with_commission">create_initialize_validators_with_commission</a>(pont_framework, <b>false</b>, validators_with_commission);
}
</code></pre>
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_create_initialize_validator">create_initialize_validator</a>(
    ...
    <b>let</b> owner = &<a href="genesis.md#0x1_genesis_create_account">create_account</a>(pont_framework, validator.owner_address, validator.stake_amount);
    <a href="genesis.md#0x1_genesis_create_account">create_account</a>(pont_framework, validator.operator_address, 0);
    <a href="genesis.md#0x1_genesis_create_account">create_account</a>(pont_framework, validator.voter_address, 0);
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_set_genesis_end">set_genesis_end</a>(pont_framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>)
</code></pre>
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_set_genesis_end">set_genesis_end</a>(pont_framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>) {
    <a href="chain_status.md#0x1_chain_status_set_genesis_end">chain_status::set_genesis_end</a>(pont_framework);
}
</code></pre>
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_create_signer">create_signer</a>(addr: <b>address</b>): <a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>
</code></pre>
...
<pre><code><b>native</b> <b>fun</b> <a href="genesis.md#0x1_genesis_create_signer">create_signer</a>(addr: <b>address</b>): <a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>;
</code></pre>
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_initialize_for_verification">initialize_for_verification</a>(<a href="gas_schedule.md#0x1_gas_schedule">gas_schedule</a>: <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;, <a href="chain_id.md#0x1_chain_id">chain_id</a>: u8, initial_version: u64, <a href="consensus_config.md#0x1_consensus_config">consensus_config</a>: <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;, epoch_interval_microsecs: u64, minimum_stake: u64, maximum_stake: u64, recurring_lockup_duration_secs: u64, allow_validator_set_change: bool, rewards_rate: u64, rewards_rate_denominator: u64, voting_power_increase_limit: u64, pont_framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, validators: <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="genesis.md#0x1_genesis_ValidatorConfiguration">genesis::ValidatorConfiguration</a>&gt;, min_voting_threshold: u128, required_proposer_stake: u64, voting_duration_secs: u64)
</code></pre>
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_initialize_for_verification">initialize_for_verification</a>(
    ...
    voting_power_increase_limit: u64,
    pont_framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>,
    validators: <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="genesis.md#0x1_genesis_ValidatorConfiguration">ValidatorConfiguration</a>&gt;,
    ...
    <a href="genesis.md#0x1_genesis_initialize_pont_coin">initialize_pont_coin</a>(pont_framework);

    <a href="pont_governance.md#0x1_pont_governance_initialize_for_verification">pont_governance::initialize_for_verification</a>(
        pont_framework,
    ...
    <a href="genesis.md#0x1_genesis_create_initialize_validators">create_initialize_validators</a>(pont_framework, validators);
    <a href="genesis.md#0x1_genesis_set_genesis_end">set_genesis_end</a>(pont_framework);
}
</code></pre>
