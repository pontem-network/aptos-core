...
<dl>
<dt>
<code>signer_caps: <a href="../../pont-stdlib/doc/simple_map.md#0x1_simple_map_SimpleMap">simple_map::SimpleMap</a>&lt;<b>address</b>, <a href="account.md#0x1_account_SignerCapability">account::SignerCapability</a>&gt;</code>
</dt>
<dd>
...
<dl>
<dt>
<code>votes: <a href="../../pont-stdlib/doc/table.md#0x1_table_Table">table::Table</a>&lt;<a href="pont_governance.md#0x1_pont_governance_RecordKey">pont_governance::RecordKey</a>, bool&gt;</code>
</dt>
<dd>
...
<dl>
<dt>
<code>hashes: <a href="../../pont-stdlib/doc/simple_map.md#0x1_simple_map_SimpleMap">simple_map::SimpleMap</a>&lt;u64, <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;&gt;</code>
</dt>
<dd>
...
<dl>
<dt>
<code>create_proposal_events: <a href="event.md#0x1_event_EventHandle">event::EventHandle</a>&lt;<a href="pont_governance.md#0x1_pont_governance_CreateProposalEvent">pont_governance::CreateProposalEvent</a>&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>update_config_events: <a href="event.md#0x1_event_EventHandle">event::EventHandle</a>&lt;<a href="pont_governance.md#0x1_pont_governance_UpdateConfigEvent">pont_governance::UpdateConfigEvent</a>&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>vote_events: <a href="event.md#0x1_event_EventHandle">event::EventHandle</a>&lt;<a href="pont_governance.md#0x1_pont_governance_VoteEvent">pont_governance::VoteEvent</a>&gt;</code>
</dt>
<dd>
...
<dt>
<code>proposal_metadata: <a href="../../pont-stdlib/doc/simple_map.md#0x1_simple_map_SimpleMap">simple_map::SimpleMap</a>&lt;<a href="../../move-stdlib/doc/string.md#0x1_string_String">string::String</a>, <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;&gt;</code>
</dt>
<dd>
...
<pre><code><b>const</b> <a href="pont_governance.md#0x1_pont_governance_EALREADY_VOTED">EALREADY_VOTED</a>: u64 = 4;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="pont_governance.md#0x1_pont_governance_store_signer_cap">store_signer_cap</a>(pont_framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, signer_address: <b>address</b>, signer_cap: <a href="account.md#0x1_account_SignerCapability">account::SignerCapability</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="pont_governance.md#0x1_pont_governance_store_signer_cap">store_signer_cap</a>(
    pont_framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>,
    signer_address: <b>address</b>,
    signer_cap: SignerCapability,
) <b>acquires</b> <a href="pont_governance.md#0x1_pont_governance_GovernanceResponsbility">GovernanceResponsbility</a> {
    <a href="system_addresses.md#0x1_system_addresses_assert_framework_reserved_address">system_addresses::assert_framework_reserved_address</a>(pont_framework);

    <b>if</b> (!<b>exists</b>&lt;<a href="pont_governance.md#0x1_pont_governance_GovernanceResponsbility">GovernanceResponsbility</a>&gt;(@pont_framework)) {
        <b>move_to</b>(pont_framework, <a href="pont_governance.md#0x1_pont_governance_GovernanceResponsbility">GovernanceResponsbility</a> { signer_caps: <a href="../../pont-stdlib/doc/simple_map.md#0x1_simple_map_create">simple_map::create</a>&lt;<b>address</b>, SignerCapability&gt;() });
    };

    <b>let</b> signer_caps = &<b>mut</b> <b>borrow_global_mut</b>&lt;<a href="pont_governance.md#0x1_pont_governance_GovernanceResponsbility">GovernanceResponsbility</a>&gt;(@pont_framework).signer_caps;
    <a href="../../pont-stdlib/doc/simple_map.md#0x1_simple_map_add">simple_map::add</a>(signer_caps, signer_address, signer_cap);
}
</code></pre>
...
<pre><code><b>fun</b> <a href="pont_governance.md#0x1_pont_governance_initialize">initialize</a>(
    pont_framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>,
    ...
    <a href="voting.md#0x1_voting_register">voting::register</a>&lt;GovernanceProposal&gt;(pont_framework);
    <b>move_to</b>(pont_framework, <a href="pont_governance.md#0x1_pont_governance_GovernanceConfig">GovernanceConfig</a> {
        voting_duration_secs,
        min_voting_threshold,
        required_proposer_stake,
    });
    <b>move_to</b>(pont_framework, <a href="pont_governance.md#0x1_pont_governance_GovernanceEvents">GovernanceEvents</a> {
        create_proposal_events: <a href="account.md#0x1_account_new_event_handle">account::new_event_handle</a>&lt;<a href="pont_governance.md#0x1_pont_governance_CreateProposalEvent">CreateProposalEvent</a>&gt;(pont_framework),
        update_config_events: <a href="account.md#0x1_account_new_event_handle">account::new_event_handle</a>&lt;<a href="pont_governance.md#0x1_pont_governance_UpdateConfigEvent">UpdateConfigEvent</a>&gt;(pont_framework),
        vote_events: <a href="account.md#0x1_account_new_event_handle">account::new_event_handle</a>&lt;<a href="pont_governance.md#0x1_pont_governance_VoteEvent">VoteEvent</a>&gt;(pont_framework),
    });
    <b>move_to</b>(pont_framework, <a href="pont_governance.md#0x1_pont_governance_VotingRecords">VotingRecords</a> {
        votes: <a href="../../pont-stdlib/doc/table.md#0x1_table_new">table::new</a>(),
    });
    <b>move_to</b>(pont_framework, <a href="pont_governance.md#0x1_pont_governance_ApprovedExecutionHashes">ApprovedExecutionHashes</a> {
        hashes: <a href="../../pont-stdlib/doc/simple_map.md#0x1_simple_map_create">simple_map::create</a>&lt;u64, <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;&gt;(),
    })
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="pont_governance.md#0x1_pont_governance_update_governance_config">update_governance_config</a>(
    pont_framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>,
    min_voting_threshold: u128,
    required_proposer_stake: u64,
    voting_duration_secs: u64,
) <b>acquires</b> <a href="pont_governance.md#0x1_pont_governance_GovernanceConfig">GovernanceConfig</a>, <a href="pont_governance.md#0x1_pont_governance_GovernanceEvents">GovernanceEvents</a> {
    <a href="system_addresses.md#0x1_system_addresses_assert_pont_framework">system_addresses::assert_pont_framework</a>(pont_framework);

    <b>let</b> governance_config = <b>borrow_global_mut</b>&lt;<a href="pont_governance.md#0x1_pont_governance_GovernanceConfig">GovernanceConfig</a>&gt;(@pont_framework);
    ...
    <b>let</b> events = <b>borrow_global_mut</b>&lt;<a href="pont_governance.md#0x1_pont_governance_GovernanceEvents">GovernanceEvents</a>&gt;(@pont_framework);
    <a href="event.md#0x1_event_emit_event">event::emit_event</a>&lt;<a href="pont_governance.md#0x1_pont_governance_UpdateConfigEvent">UpdateConfigEvent</a>&gt;(
        &<b>mut</b> events.update_config_events,
        <a href="pont_governance.md#0x1_pont_governance_UpdateConfigEvent">UpdateConfigEvent</a> {
            min_voting_threshold,
            required_proposer_stake,
            voting_duration_secs
        },
...
<pre><code><b>public</b> <b>fun</b> <a href="pont_governance.md#0x1_pont_governance_get_voting_duration_secs">get_voting_duration_secs</a>(): u64 <b>acquires</b> <a href="pont_governance.md#0x1_pont_governance_GovernanceConfig">GovernanceConfig</a> {
    <b>borrow_global</b>&lt;<a href="pont_governance.md#0x1_pont_governance_GovernanceConfig">GovernanceConfig</a>&gt;(@pont_framework).voting_duration_secs
}
</code></pre>
...
<a name="0x1_pont_governance_get_min_voting_threshold"></a>
...
<pre><code><b>public</b> <b>fun</b> <a href="pont_governance.md#0x1_pont_governance_get_min_voting_threshold">get_min_voting_threshold</a>(): u128 <b>acquires</b> <a href="pont_governance.md#0x1_pont_governance_GovernanceConfig">GovernanceConfig</a> {
    <b>borrow_global</b>&lt;<a href="pont_governance.md#0x1_pont_governance_GovernanceConfig">GovernanceConfig</a>&gt;(@pont_framework).min_voting_threshold
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="pont_governance.md#0x1_pont_governance_get_required_proposer_stake">get_required_proposer_stake</a>(): u64 <b>acquires</b> <a href="pont_governance.md#0x1_pont_governance_GovernanceConfig">GovernanceConfig</a> {
    <b>borrow_global</b>&lt;<a href="pont_governance.md#0x1_pont_governance_GovernanceConfig">GovernanceConfig</a>&gt;(@pont_framework).required_proposer_stake
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="pont_governance.md#0x1_pont_governance_create_proposal">create_proposal</a>(
    ...
    <b>assert</b>!(<a href="stake.md#0x1_stake_get_delegated_voter">stake::get_delegated_voter</a>(stake_pool) == proposer_address, <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="pont_governance.md#0x1_pont_governance_ENOT_DELEGATED_VOTER">ENOT_DELEGATED_VOTER</a>));

    // The proposer's <a href="stake.md#0x1_stake">stake</a> needs <b>to</b> be at least the required bond amount.
    <b>let</b> governance_config = <b>borrow_global</b>&lt;<a href="pont_governance.md#0x1_pont_governance_GovernanceConfig">GovernanceConfig</a>&gt;(@pont_framework);
    <b>let</b> stake_balance = <a href="pont_governance.md#0x1_pont_governance_get_voting_power">get_voting_power</a>(stake_pool);
    <b>assert</b>!(
        stake_balance &gt;= governance_config.required_proposer_stake,
        <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="pont_governance.md#0x1_pont_governance_EINSUFFICIENT_PROPOSER_STAKE">EINSUFFICIENT_PROPOSER_STAKE</a>),
    );
    ...
    <b>assert</b>!(
        ...
        <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="pont_governance.md#0x1_pont_governance_EINSUFFICIENT_STAKE_LOCKUP">EINSUFFICIENT_STAKE_LOCKUP</a>),
    );

    // Create and validate proposal metadata.
    <b>let</b> proposal_metadata = <a href="pont_governance.md#0x1_pont_governance_create_proposal_metadata">create_proposal_metadata</a>(metadata_location, metadata_hash);
    ...
    <b>let</b> total_voting_token_supply = <a href="coin.md#0x1_coin_supply">coin::supply</a>&lt;PontCoin&gt;();
    ...
    <b>let</b> proposal_id = <a href="voting.md#0x1_voting_create_proposal">voting::create_proposal</a>(
        proposer_address,
        @pont_framework,
    ...
    <b>let</b> events = <b>borrow_global_mut</b>&lt;<a href="pont_governance.md#0x1_pont_governance_GovernanceEvents">GovernanceEvents</a>&gt;(@pont_framework);
    <a href="event.md#0x1_event_emit_event">event::emit_event</a>&lt;<a href="pont_governance.md#0x1_pont_governance_CreateProposalEvent">CreateProposalEvent</a>&gt;(
        &<b>mut</b> events.create_proposal_events,
        <a href="pont_governance.md#0x1_pont_governance_CreateProposalEvent">CreateProposalEvent</a> {
            proposal_id,
...
<pre><code><b>public</b> entry <b>fun</b> <a href="pont_governance.md#0x1_pont_governance_vote">vote</a>(
    voter: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>,
    stake_pool: <b>address</b>,
    proposal_id: u64,
    should_pass: bool,
) <b>acquires</b> <a href="pont_governance.md#0x1_pont_governance_ApprovedExecutionHashes">ApprovedExecutionHashes</a>, <a href="pont_governance.md#0x1_pont_governance_GovernanceEvents">GovernanceEvents</a>, <a href="pont_governance.md#0x1_pont_governance_VotingRecords">VotingRecords</a> {
    <b>let</b> voter_address = <a href="../../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(voter);
    <b>assert</b>!(<a href="stake.md#0x1_stake_get_delegated_voter">stake::get_delegated_voter</a>(stake_pool) == voter_address, <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="pont_governance.md#0x1_pont_governance_ENOT_DELEGATED_VOTER">ENOT_DELEGATED_VOTER</a>));

    // Ensure the voter doesn't double vote <b>with</b> the same <a href="stake.md#0x1_stake">stake</a> pool.
    <b>let</b> voting_records = <b>borrow_global_mut</b>&lt;<a href="pont_governance.md#0x1_pont_governance_VotingRecords">VotingRecords</a>&gt;(@pont_framework);
    <b>let</b> record_key = <a href="pont_governance.md#0x1_pont_governance_RecordKey">RecordKey</a> {
        stake_pool,
        proposal_id,
    };
    <b>assert</b>!(
        !<a href="../../pont-stdlib/doc/table.md#0x1_table_contains">table::contains</a>(&voting_records.votes, record_key),
        <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="pont_governance.md#0x1_pont_governance_EALREADY_VOTED">EALREADY_VOTED</a>));
    <a href="../../pont-stdlib/doc/table.md#0x1_table_add">table::add</a>(&<b>mut</b> voting_records.votes, record_key, <b>true</b>);

    <b>let</b> voting_power = <a href="pont_governance.md#0x1_pont_governance_get_voting_power">get_voting_power</a>(stake_pool);
    // Short-circuit <b>if</b> the voter <b>has</b> no <a href="voting.md#0x1_voting">voting</a> power.
    <b>assert</b>!(voting_power &gt; 0, <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="pont_governance.md#0x1_pont_governance_ENO_VOTING_POWER">ENO_VOTING_POWER</a>));
    ...
    <b>let</b> proposal_expiration = <a href="voting.md#0x1_voting_get_proposal_expiration_secs">voting::get_proposal_expiration_secs</a>&lt;GovernanceProposal&gt;(@pont_framework, proposal_id);
    <b>assert</b>!(
        <a href="stake.md#0x1_stake_get_lockup_secs">stake::get_lockup_secs</a>(stake_pool) &gt;= proposal_expiration,
        <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="pont_governance.md#0x1_pont_governance_EINSUFFICIENT_STAKE_LOCKUP">EINSUFFICIENT_STAKE_LOCKUP</a>),
    );
    ...
    <b>let</b> events = <b>borrow_global_mut</b>&lt;<a href="pont_governance.md#0x1_pont_governance_GovernanceEvents">GovernanceEvents</a>&gt;(@pont_framework);
    <a href="event.md#0x1_event_emit_event">event::emit_event</a>&lt;<a href="pont_governance.md#0x1_pont_governance_VoteEvent">VoteEvent</a>&gt;(
        &<b>mut</b> events.vote_events,
        <a href="pont_governance.md#0x1_pont_governance_VoteEvent">VoteEvent</a> {
            proposal_id,
            voter: voter_address,
            stake_pool,
    ...
    <b>let</b> proposal_state = <a href="voting.md#0x1_voting_get_proposal_state">voting::get_proposal_state</a>&lt;GovernanceProposal&gt;(@pont_framework, proposal_id);
    <b>if</b> (proposal_state == <a href="pont_governance.md#0x1_pont_governance_PROPOSAL_STATE_SUCCEEDED">PROPOSAL_STATE_SUCCEEDED</a>) {
        <a href="pont_governance.md#0x1_pont_governance_add_approved_script_hash">add_approved_script_hash</a>(proposal_id);
    }
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="pont_governance.md#0x1_pont_governance_add_approved_script_hash_script">add_approved_script_hash_script</a>(proposal_id: u64) <b>acquires</b> <a href="pont_governance.md#0x1_pont_governance_ApprovedExecutionHashes">ApprovedExecutionHashes</a> {
    <a href="pont_governance.md#0x1_pont_governance_add_approved_script_hash">add_approved_script_hash</a>(proposal_id)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="pont_governance.md#0x1_pont_governance_add_approved_script_hash">add_approved_script_hash</a>(proposal_id: u64) <b>acquires</b> <a href="pont_governance.md#0x1_pont_governance_ApprovedExecutionHashes">ApprovedExecutionHashes</a> {
    <b>let</b> approved_hashes = <b>borrow_global_mut</b>&lt;<a href="pont_governance.md#0x1_pont_governance_ApprovedExecutionHashes">ApprovedExecutionHashes</a>&gt;(@pont_framework);
    // Prevent adding the same <b>script</b> <a href="../../pont-stdlib/doc/hash.md#0x1_hash">hash</a> <b>to</b> the list multiple times.
    <b>if</b> (<a href="../../pont-stdlib/doc/simple_map.md#0x1_simple_map_contains_key">simple_map::contains_key</a>(&approved_hashes.hashes, &proposal_id)) {
        <b>return</b>
    };

    // Ensure the proposal can be resolved.
    <b>let</b> proposal_state = <a href="voting.md#0x1_voting_get_proposal_state">voting::get_proposal_state</a>&lt;GovernanceProposal&gt;(@pont_framework, proposal_id);
    <b>assert</b>!(proposal_state == <a href="pont_governance.md#0x1_pont_governance_PROPOSAL_STATE_SUCCEEDED">PROPOSAL_STATE_SUCCEEDED</a>, <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="pont_governance.md#0x1_pont_governance_EPROPOSAL_NOT_RESOLVABLE_YET">EPROPOSAL_NOT_RESOLVABLE_YET</a>));

    <b>let</b> execution_hash = <a href="voting.md#0x1_voting_get_execution_hash">voting::get_execution_hash</a>&lt;GovernanceProposal&gt;(@pont_framework, proposal_id);
    <a href="../../pont-stdlib/doc/simple_map.md#0x1_simple_map_add">simple_map::add</a>(&<b>mut</b> approved_hashes.hashes, proposal_id, execution_hash);
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="pont_governance.md#0x1_pont_governance_resolve">resolve</a>(proposal_id: u64, signer_address: <b>address</b>): <a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a> <b>acquires</b> <a href="pont_governance.md#0x1_pont_governance_ApprovedExecutionHashes">ApprovedExecutionHashes</a>, <a href="pont_governance.md#0x1_pont_governance_GovernanceResponsbility">GovernanceResponsbility</a> {
    <a href="voting.md#0x1_voting_resolve">voting::resolve</a>&lt;GovernanceProposal&gt;(@pont_framework, proposal_id);
    <a href="pont_governance.md#0x1_pont_governance_remove_approved_hash">remove_approved_hash</a>(proposal_id);
    <a href="pont_governance.md#0x1_pont_governance_get_signer">get_signer</a>(signer_address)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="pont_governance.md#0x1_pont_governance_remove_approved_hash">remove_approved_hash</a>(proposal_id: u64) <b>acquires</b> <a href="pont_governance.md#0x1_pont_governance_ApprovedExecutionHashes">ApprovedExecutionHashes</a> {
    <b>assert</b>!(
        <a href="voting.md#0x1_voting_is_resolved">voting::is_resolved</a>&lt;GovernanceProposal&gt;(@pont_framework, proposal_id),
        <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="pont_governance.md#0x1_pont_governance_EPROPOSAL_NOT_RESOLVED_YET">EPROPOSAL_NOT_RESOLVED_YET</a>),
    );

    <b>let</b> approved_hashes = &<b>mut</b> <b>borrow_global_mut</b>&lt;<a href="pont_governance.md#0x1_pont_governance_ApprovedExecutionHashes">ApprovedExecutionHashes</a>&gt;(@pont_framework).hashes;
    <b>if</b> (<a href="../../pont-stdlib/doc/simple_map.md#0x1_simple_map_contains_key">simple_map::contains_key</a>(approved_hashes, &proposal_id)) {
        <a href="../../pont-stdlib/doc/simple_map.md#0x1_simple_map_remove">simple_map::remove</a>(approved_hashes, &proposal_id);
    };
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="pont_governance.md#0x1_pont_governance_get_signer_testnet_only">get_signer_testnet_only</a>(
    core_resources: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, signer_address: <b>address</b>): <a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a> <b>acquires</b> <a href="pont_governance.md#0x1_pont_governance_GovernanceResponsbility">GovernanceResponsbility</a> {
    ...
    <b>assert</b>!(<a href="pont_coin.md#0x1_pont_coin_has_mint_capability">pont_coin::has_mint_capability</a>(core_resources), <a href="../../move-stdlib/doc/error.md#0x1_error_unauthenticated">error::unauthenticated</a>(<a href="pont_governance.md#0x1_pont_governance_EUNAUTHORIZED">EUNAUTHORIZED</a>));
    <a href="pont_governance.md#0x1_pont_governance_get_signer">get_signer</a>(signer_address)
}
</code></pre>
...
<pre><code><b>fun</b> <a href="pont_governance.md#0x1_pont_governance_get_signer">get_signer</a>(signer_address: <b>address</b>): <a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a> <b>acquires</b> <a href="pont_governance.md#0x1_pont_governance_GovernanceResponsbility">GovernanceResponsbility</a> {
    <b>let</b> governance_responsibility = <b>borrow_global</b>&lt;<a href="pont_governance.md#0x1_pont_governance_GovernanceResponsbility">GovernanceResponsbility</a>&gt;(@pont_framework);
    <b>let</b> signer_cap = <a href="../../pont-stdlib/doc/simple_map.md#0x1_simple_map_borrow">simple_map::borrow</a>(&governance_responsibility.signer_caps, &signer_address);
...
<pre><code><b>fun</b> <a href="pont_governance.md#0x1_pont_governance_create_proposal_metadata">create_proposal_metadata</a>(metadata_location: <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;, metadata_hash: <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;): SimpleMap&lt;String, <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;&gt; {
    <b>assert</b>!(<a href="../../move-stdlib/doc/string.md#0x1_string_length">string::length</a>(&utf8(metadata_location)) &lt;= 256, <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="pont_governance.md#0x1_pont_governance_EMETADATA_LOCATION_TOO_LONG">EMETADATA_LOCATION_TOO_LONG</a>));
    <b>assert</b>!(<a href="../../move-stdlib/doc/string.md#0x1_string_length">string::length</a>(&utf8(metadata_hash)) &lt;= 256, <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="pont_governance.md#0x1_pont_governance_EMETADATA_HASH_TOO_LONG">EMETADATA_HASH_TOO_LONG</a>));

    <b>let</b> metadata = <a href="../../pont-stdlib/doc/simple_map.md#0x1_simple_map_create">simple_map::create</a>&lt;String, <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;&gt;();
    <a href="../../pont-stdlib/doc/simple_map.md#0x1_simple_map_add">simple_map::add</a>(&<b>mut</b> metadata, utf8(<a href="pont_governance.md#0x1_pont_governance_METADATA_LOCATION_KEY">METADATA_LOCATION_KEY</a>), metadata_location);
    <a href="../../pont-stdlib/doc/simple_map.md#0x1_simple_map_add">simple_map::add</a>(&<b>mut</b> metadata, utf8(<a href="pont_governance.md#0x1_pont_governance_METADATA_HASH_KEY">METADATA_HASH_KEY</a>), metadata_hash);
    metadata
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="pont_governance.md#0x1_pont_governance_initialize_for_verification">initialize_for_verification</a>(
    pont_framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>,
    min_voting_threshold: u128,
    required_proposer_stake: u64,
    voting_duration_secs: u64,
) {
    <a href="pont_governance.md#0x1_pont_governance_initialize">initialize</a>(pont_framework, min_voting_threshold, required_proposer_stake, voting_duration_secs);
}
</code></pre>
