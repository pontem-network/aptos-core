...
<dt>
<code>extension: <a href="../../move-stdlib/doc/option.md#0x1_option_Option">option::Option</a>&lt;<a href="../../pont-stdlib/doc/copyable_any.md#0x1_copyable_any_Any">copyable_any::Any</a>&gt;</code>
</dt>
<dd>
...
<pre><code><b>fun</b> <a href="code.md#0x1_code_initialize">initialize</a>(pont_framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, package_owner: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, metadata: <a href="code.md#0x1_code_PackageMetadata">PackageMetadata</a>)
...
<pre><code><b>public</b> <b>fun</b> <a href="code.md#0x1_code_publish_package">publish_package</a>(owner: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, pack: <a href="code.md#0x1_code_PackageMetadata">PackageMetadata</a>, <a href="code.md#0x1_code">code</a>: <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;&gt;) <b>acquires</b> <a href="code.md#0x1_code_PackageRegistry">PackageRegistry</a> {
    ...
    <b>let</b> len = <a href="../../move-stdlib/doc/vector.md#0x1_vector_length">vector::length</a>(packages);
    <b>let</b> index = len;
    <b>let</b> i = 0;
    <b>let</b> upgrade_number = 0;
    <b>while</b> (i &lt; len) {
        <b>let</b> <b>old</b> = <a href="../../move-stdlib/doc/vector.md#0x1_vector_borrow">vector::borrow</a>(packages, i);
...
<pre><code><b>fun</b> <a href="code.md#0x1_code_check_upgradability">check_upgradability</a>(
    ...
    <b>let</b> i = 0;
    <b>while</b> (i &lt; <a href="../../move-stdlib/doc/vector.md#0x1_vector_length">vector::length</a>(&old_modules)) {
        <b>assert</b>!(
            <a href="../../move-stdlib/doc/vector.md#0x1_vector_contains">vector::contains</a>(new_modules, <a href="../../move-stdlib/doc/vector.md#0x1_vector_borrow">vector::borrow</a>(&old_modules, i)),
...
<pre><code><b>fun</b> <a href="code.md#0x1_code_check_coexistence">check_coexistence</a>(old_pack: &<a href="code.md#0x1_code_PackageMetadata">PackageMetadata</a>, new_modules: &<a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;String&gt;) {
    ...
    <b>let</b> i = 0;
    <b>while</b> (i &lt; <a href="../../move-stdlib/doc/vector.md#0x1_vector_length">vector::length</a>(&old_pack.modules)) {
        <b>let</b> old_mod = <a href="../../move-stdlib/doc/vector.md#0x1_vector_borrow">vector::borrow</a>(&old_pack.modules, i);
        <b>let</b> j = 0;
...
<b>acquires</b> <a href="code.md#0x1_code_PackageRegistry">PackageRegistry</a> {
    ...
    <b>let</b> i = 0;
    <b>let</b> n = <a href="../../move-stdlib/doc/vector.md#0x1_vector_length">vector::length</a>(deps);
    <b>while</b> (i &lt; n) {
        <b>let</b> dep = <a href="../../move-stdlib/doc/vector.md#0x1_vector_borrow">vector::borrow</a>(deps, i);
        ...
        <b>let</b> j = 0;
        <b>let</b> m = <a href="../../move-stdlib/doc/vector.md#0x1_vector_length">vector::length</a>(&registry.packages);
        <b>let</b> found = <b>false</b>;
        <b>while</b> (j &lt; m) {
            <b>let</b> dep_pack = <a href="../../move-stdlib/doc/vector.md#0x1_vector_borrow">vector::borrow</a>(&registry.packages, j);
...
<pre><code><b>fun</b> <a href="code.md#0x1_code_get_module_names">get_module_names</a>(pack: &<a href="code.md#0x1_code_PackageMetadata">PackageMetadata</a>): <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;String&gt; {
    ...
    <b>let</b> i = 0;
    <b>while</b> (i &lt; <a href="../../move-stdlib/doc/vector.md#0x1_vector_length">vector::length</a>(&pack.modules)) {
        <a href="../../move-stdlib/doc/vector.md#0x1_vector_push_back">vector::push_back</a>(&<b>mut</b> module_names, <a href="../../move-stdlib/doc/vector.md#0x1_vector_borrow">vector::borrow</a>(&pack.modules, i).name);
        i = i + 1
    };
    module_names
}
