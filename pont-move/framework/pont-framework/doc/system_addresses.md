...
-  [Function `assert_pont_framework`](#0x1_system_addresses_assert_pont_framework)
...
-  [Function `is_pont_framework_address`](#0x1_system_addresses_is_pont_framework_address)
...
-  [Specification](#@Specification_1)
    ...
    -  [Function `assert_pont_framework`](#@Specification_1_assert_pont_framework)
...
<a name="0x1_system_addresses_assert_pont_framework"></a>

## Function `assert_pont_framework`



<pre><code><b>public</b> <b>fun</b> <a href="system_addresses.md#0x1_system_addresses_assert_pont_framework">assert_pont_framework</a>(<a href="account.md#0x1_account">account</a>: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="system_addresses.md#0x1_system_addresses_assert_pont_framework">assert_pont_framework</a>(<a href="account.md#0x1_account">account</a>: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>) {
    <b>assert</b>!(
        <a href="system_addresses.md#0x1_system_addresses_is_pont_framework_address">is_pont_framework_address</a>(<a href="../../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(<a href="account.md#0x1_account">account</a>)),
...
<pre><code><b>public</b> <b>fun</b> <a href="system_addresses.md#0x1_system_addresses_assert_framework_reserved_address">assert_framework_reserved_address</a>(<a href="account.md#0x1_account">account</a>: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>) {
    <b>assert</b>!(
        <a href="system_addresses.md#0x1_system_addresses_is_framework_reserved_address">is_framework_reserved_address</a>(<a href="../../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(<a href="account.md#0x1_account">account</a>)),
...
<pre><code><b>public</b> <b>fun</b> <a href="system_addresses.md#0x1_system_addresses_is_framework_reserved_address">is_framework_reserved_address</a>(addr: <b>address</b>): bool {
    <a href="system_addresses.md#0x1_system_addresses_is_pont_framework_address">is_pont_framework_address</a>(addr) ||
        addr == @0x2 ||
        addr == @0x3 ||
        addr == @0x4 ||
        addr == @0x5 ||
...
<a name="0x1_system_addresses_is_pont_framework_address"></a>

## Function `is_pont_framework_address`

Return true if <code>addr</code> is 0x1.


<pre><code><b>public</b> <b>fun</b> <a href="system_addresses.md#0x1_system_addresses_is_pont_framework_address">is_pont_framework_address</a>(addr: <b>address</b>): bool
</code></pre>
...
Return true if <code>addr</code> is either the VM address or an Pont Framework address.
...
<pre><code><b>public</b> <b>fun</b> <a href="system_addresses.md#0x1_system_addresses_is_reserved_address">is_reserved_address</a>(addr: <b>address</b>): bool {
    <a href="system_addresses.md#0x1_system_addresses_is_pont_framework_address">is_pont_framework_address</a>(addr) || <a href="system_addresses.md#0x1_system_addresses_is_vm_address">is_vm_address</a>(addr)
}
</code></pre>
...
<a name="@Specification_1_assert_pont_framework"></a>
...
<pre><code><b>pragma</b> opaque;
<b>include</b> <a href="system_addresses.md#0x1_system_addresses_AbortsIfNotPontFramework">AbortsIfNotPontFramework</a>;
</code></pre>
