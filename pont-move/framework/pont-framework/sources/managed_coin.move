...
module pont_framework::managed_coin {
    use std::string;
    use std::error;
    use std::signer;

    use pont_framework::coin::{Self, BurnCapability, FreezeCapability, MintCapability};
    ...
    /// Initialize new coin `CoinType` in Pont Blockchain.
    ...
    public entry fun test_end_to_end(
        ...
        pont_framework::account::create_account_for_test(source_addr);
        pont_framework::account::create_account_for_test(destination_addr);
        pont_framework::account::create_account_for_test(signer::address_of(&mod_account));
    ...
    public entry fun fail_mint(
        ...
        pont_framework::account::create_account_for_test(source_addr);
        pont_framework::account::create_account_for_test(signer::address_of(&destination));
        pont_framework::account::create_account_for_test(signer::address_of(&mod_account));
        aggregator_factory::initialize_aggregator_factory_for_test(&mod_account);
