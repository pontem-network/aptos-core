spec pont_framework::timestamp {
    spec module {
        use pont_framework::chain_status;
        invariant chain_status::is_operating() ==> exists<CurrentTimeMicroseconds>(@pont_framework);
    }
    ...
    spec fun spec_now_microseconds(): u64 {
        global<CurrentTimeMicroseconds>(@pont_framework).microseconds
    }
