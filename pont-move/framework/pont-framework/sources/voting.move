...
module pont_framework::voting {
    ...
    use pont_framework::transaction_context;
    ...
    #[test(pont_framework = @pont_framework, governance = @0x123)]
    public entry fun test_voting_passed(pont_framework: &signer, governance: &signer) acquires VotingForum {
        account::create_account_for_test(@pont_framework);
    ...
    public entry fun test_cannot_resolve_twice(pont_framework: &signer, governance: &signer) acquires VotingForum {
        account::create_account_for_test(@pont_framework);
        timestamp::set_time_has_started_for_testing(pont_framework);
    ...
    #[test(pont_framework = @pont_framework, governance = @0x123)]
    public entry fun test_voting_passed_early(pont_framework: &signer, governance: &signer) acquires VotingForum {
        account::create_account_for_test(@pont_framework);
        timestamp::set_time_has_started_for_testing(pont_framework);
    ...
    public entry fun test_voting_passed_early_in_same_tx_should_fail(
        pont_framework: &signer, governance: &signer) acquires VotingForum {
        account::create_account_for_test(@pont_framework);
        timestamp::set_time_has_started_for_testing(pont_framework);
        let governance_address = signer::address_of(governance);
        account::create_account_for_test(governance_address);
    ...
    public entry fun test_voting_failed(pont_framework: &signer, governance: &signer) acquires VotingForum {
        account::create_account_for_test(@pont_framework);
        timestamp::set_time_has_started_for_testing(pont_framework);
    ...
    #[test(pont_framework = @pont_framework, governance = @0x123)]
    #[expected_failure(abort_code = 0x30002)]
    public entry fun test_voting_failed_early(pont_framework: &signer, governance: &signer) acquires VotingForum {
        account::create_account_for_test(@pont_framework);
        timestamp::set_time_has_started_for_testing(pont_framework);
