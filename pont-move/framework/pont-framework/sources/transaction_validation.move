module pont_framework::transaction_validation {
    use std::error;
    use std::signer;
    use std::vector;
    ...
    public(friend) fun initialize(
        ...
        move_to(pont_framework, TransactionValidation {
    ...
    fun prologue_common(
        ...
        assert!(
            coin::is_account_registered<PontCoin>(transaction_sender),
            error::invalid_argument(PROLOGUE_ECANT_PAY_GAS_DEPOSIT),
        );
        let balance = coin::balance<PontCoin>(transaction_sender);
    ...
    fun epilogue(
        ...
        assert!(
            coin::balance<PontCoin>(addr) >= transaction_fee_amount,
