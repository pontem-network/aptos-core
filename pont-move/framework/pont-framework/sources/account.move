module pont_framework::account {
    ...
    friend pont_framework::pont_account;
    friend pont_framework::coin;
    ...
    public(friend) fun initialize(pont_framework: &signer) {
        ...
        move_to(pont_framework, OriginatingAddress {
    ...
    public entry fun rotate_authentication_key(
        ...
        let address_map = &mut borrow_global_mut<OriginatingAddress>(@pont_framework).address_map;
    ...
    /// `create_account` to attempt to claim an account ahead of the creation of a resource account, if found Pont will
    ...
    */
    ...
    // NOTE: These test cases were generated using `cargo test -- offer_signer_capability_v2 --nocapture` in `pont-move/e2e-move-tests/src/tests`
    #[test_only]
