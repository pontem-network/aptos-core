spec pont_framework::storage_gas {
    // -----------------
    // Struct invariants
    // -----------------
    ...
    spec module {
        ...
        invariant [suspendable] chain_status::is_operating() ==> exists<StorageGasConfig>(@pont_framework);
        invariant [suspendable] chain_status::is_operating() ==> exists<StorageGas>(@pont_framework);
    }
