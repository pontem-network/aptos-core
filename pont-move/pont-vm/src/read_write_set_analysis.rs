...
impl<'a, R: MoveResolverExt> ReadWriteSetAnalysis<'a, R> {
    /// Create a Pont transaction read/write set analysis from a generic Move module read/write set
    ...
    fn get_concretized_keys_entry_function(
        ...
        // to do as of Pont 1.4, but should be re-evaluated if the epilogue changes
