...
custom_edit_url: https://github.com/aptos-labs/pont-core/edit/main/language/move-binary-format/vm-runtime/README.md
---
...
Every transaction executes within the context of a [Pont
...
1. ***Transaction Prologue*** - in verification mode the runtime runs the
   ...
   prologue defined in the [Pont account
...
3. ***Transaction Epilogue*** - in execution mode the epilogue defined in
   the [Pont account module](../framework/modules/diem_account.mvir) is
