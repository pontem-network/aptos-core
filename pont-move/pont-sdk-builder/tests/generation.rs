...
use pont_sdk_builder as buildgen;
use pont_types::transaction::EntryABI;
...
fn get_pont_registry() -> Registry {
    let path = "../../testsuite/generate-format/tests/staged/pont.yaml";
...
[dependencies]
pont-types = {{ path = "../pont-types", version = "0.1.0" }}
serde_bytes = "0.11.6"
...
#[test]
// Ignored because transactions require minting/transfering Coin<PontCoin>, which the
