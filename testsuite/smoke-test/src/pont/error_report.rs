...
use forge::{PontPublicInfo, Swarm};
use pont_sdk::{transaction_builder::TransactionBuilder, types::LocalAccount};
use pont_types::{
...
async fn test_error_report() {
    ...
    submit_and_check_err(
        &local_account,
        &mut info,
        |t| t.sender(pont_test_root_address()),
    ...
    submit_and_check_err(
        ...
        &mut info,
        |t| {
            t.sender(pont_test_root_address())
