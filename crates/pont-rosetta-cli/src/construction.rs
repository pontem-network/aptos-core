...
use pont::common::types::{EncodingOptions, PrivateKeyInputOptions, ProfileOptions};
use pont_logger::info;
use pont_rosetta::types::TransactionIdentifier;
...
pub struct CreateAccountCommand {
    ...
    #[clap(long, parse(try_from_str=pont::common::types::load_account_arg))]
