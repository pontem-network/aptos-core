...
use pont_crypto::ed25519::Ed25519PublicKey;
use pont_crypto::{bls12381, ed25519::Ed25519PrivateKey, x25519, PrivateKey};
use pont_genesis::config::HostAndPort;
use pont_keygen::KeyGen;
use pont_logger::warn;
use pont_rest_client::pont_api_types::{IdentifierWrapper, MoveStructTag};
use pont_rest_client::{pont_api_types::MoveType, Transaction};
use pont_sdk::move_types::account_address::AccountAddress;
use pont_sdk::move_types::identifier::Identifier;
use pont_sdk::move_types::language_storage::ModuleId;
...
impl CliTestFramework {
    ...
    async fn check_account_exists(&self, index: usize) -> bool {
        ...
        let client = pont_rest_client::Client::new(self.endpoint.clone());
    ...
    pub async fn transfer_invalid_addr(
        ...
        RunFunction {
            ...
            type_args: vec![MoveType::Struct(MoveStructTag::new(
                ...
                IdentifierWrapper::from_str("pont_coin").unwrap(),
                IdentifierWrapper::from_str("PontCoin").unwrap(),
                vec![],
            ))],
            txn_options: self.transaction_options(sender_index, gas_options),
        }
    ...
    async fn last_n_transactions_details(&self, count: u16) -> String {
        let result = pont_rest_client::Client::new(self.endpoint.clone())
    ...
    pub fn add_move_files(&self) {
        ...
        let hello_blockchain_contents = include_str!(
            "../../../../pont-move/move-examples/hello_blockchain/sources/hello_blockchain.move"
        );
        ...
        let hello_blockchain_test_contents = include_str!("../../../../pont-move/move-examples/hello_blockchain/sources/hello_blockchain_test.move");
