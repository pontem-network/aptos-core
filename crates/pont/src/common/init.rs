...
pub const DEFAULT_REST_URL: &str = "https://fullnode.devnet.pontlabs.com/v1";
pub const DEFAULT_FAUCET_URL: &str = "https://faucet.devnet.pontlabs.com";
...
impl CliCommand<()> for InitTool {
    ...
    async fn execute(self) -> CliTypedResult<()> {
        ...
        let client = pont_rest_client::Client::new(rest_url);
        ...
        config.save()?;
        eprintln!("Pont is now set up for account {}!  Run `pont help` for more information about commands", address);
        Ok(())
    }
}
