...
use pont_faucet::{mint, mint::MintParams, Service};
use pont_sdk::types::{
...
#[derive(Debug, Parser)]
#[clap(name = "pont-faucet-cli", author, version)]
pub struct FaucetCliArgs {
    /// Pont fullnode/validator server URL
    #[clap(long, default_value = "https://fullnode.devnet.pontlabs.com/")]
    pub server_url: Url,
    ...
    #[clap(long, default_value = "/opt/pont/etc/mint.key", parse(from_os_str))]
