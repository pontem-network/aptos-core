...
macro_rules! build_information {
    () => {{
        let mut build_information = pont_build_info::get_build_information();

        build_information.insert(
            pont_build_info::BUILD_PKG_VERSION.into(),
...
fn get_build_profile_name() -> String {
    ...
    // e.g. /code/core/target/debug/build/pont-build-info-9f91ba6f99d7a061/out
    std::env!("OUT_DIR")
