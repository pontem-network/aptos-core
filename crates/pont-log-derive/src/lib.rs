...
pub fn derive(input: TokenStream) -> TokenStream {
    ...
    let from_serde = quote! { ::pont_logger::Value::from_serde };
    let from_display = quote! { ::pont_logger::Value::from_display };
    let from_debug = quote! { ::pont_logger::Value::from_debug };
    let key_new = quote! { ::pont_logger::Key::new };
    ...
    let expanded = quote! {
        ...
        impl #impl_generics ::pont_logger::Schema for #name #ty_generics #where_clause {
            fn visit(&self, visitor: &mut dyn ::pont_logger::Visitor) {
                #(#visits)*
            }
        }
    };
