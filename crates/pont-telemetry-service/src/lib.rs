...
use pont_types::{chain_id::ChainId, PeerId};
...
#[clap(name = "Pont Telemetry Service", author, version)]
pub struct PontTelemetryServiceArgs {
    #[clap(short = 'f', long, parse(from_os_str))]
    config_path: PathBuf,
}

impl PontTelemetryServiceArgs {
    pub async fn run(self) {
        ...
        let validators = Arc::new(pont_infallible::RwLock::new(HashMap::new()));
        let validator_fullnodes = Arc::new(pont_infallible::RwLock::new(HashMap::new()));
