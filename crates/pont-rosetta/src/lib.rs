...
use pont_config::config::ApiConfig;
use pont_logger::{debug, warn};
use pont_types::{account_address::AccountAddress, chain_id::ChainId};
use pont_warp_webserver::{logger, Error, WebServer};
use std::{
...
pub struct RosettaContext {
    ...
    rest_client: Option<Arc<pont_rest_client::Client>>,
...
impl RosettaContext {
    ...
    fn rest_client(&self) -> ApiResult<Arc<pont_rest_client::Client>> {
...
pub fn bootstrap(
    ...
    rest_client: Option<pont_rest_client::Client>,
    owner_addresses: Vec<AccountAddress>,
