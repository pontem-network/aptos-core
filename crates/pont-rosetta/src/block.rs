...
async fn get_block_by_index(
    ...
    block_height: u64,
    chain_id: ChainId,
) -> ApiResult<(BlockIdentifier, pont_rest_client::pont_api_types::BcsBlock)> {
...
pub struct BlockRetriever {
    page_size: u16,
    rest_client: Arc<pont_rest_client::Client>,
}

impl BlockRetriever {
    pub fn new(page_size: u16, rest_client: Arc<pont_rest_client::Client>) -> Self {
        BlockRetriever {
            page_size,
            rest_client,
        }
    ...
    ) -> ApiResult<pont_rest_client::pont_api_types::BcsBlock> {
