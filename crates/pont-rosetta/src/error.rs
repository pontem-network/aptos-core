...
use pont_rest_client::pont_api_types::PontErrorCode;
    ...
    fn from(err: RestError) -> Self {
        match err {
            RestError::Api(err) => match err.error.error_code {
                ...
                PontErrorCode::ModuleNotFound => ApiError::ModuleNotFound(Some(err.error.message)),
                ...
                PontErrorCode::BlockNotFound => ApiError::BlockNotFound(Some(err.error.message)),
                PontErrorCode::VersionPruned => ApiError::VersionPruned(Some(err.error.message)),
                PontErrorCode::BlockPruned => ApiError::BlockPruned(Some(err.error.message)),
                PontErrorCode::InvalidInput => ApiError::InvalidInput(Some(err.error.message)),
                ...
                PontErrorCode::VmError => ApiError::VmError(Some(err.error.message)),
                PontErrorCode::HealthCheckFailed => {
                    ApiError::InternalError(Some(err.error.message))
                }
                PontErrorCode::MempoolIsFull => ApiError::MempoolIsFull(Some(err.error.message)),
                PontErrorCode::WebFrameworkError => {
                    ApiError::InternalError(Some(err.error.message))
                }
                PontErrorCode::BcsNotSupported => ApiError::InvalidInput(Some(err.error.message)),
                PontErrorCode::InternalError => ApiError::InternalError(Some(err.error.message)),
                PontErrorCode::ApiDisabled => ApiError::InternalError(Some(err.error.message)),
            },
