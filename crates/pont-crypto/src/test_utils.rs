...
) -> impl Strategy<Value = (EdwardsPoint, EdwardsPoint, TestPontCrypto)> {
    (
...
pub struct TestPontCrypto(pub String);
...
// #[cfg(any(test, feature = "fuzzing"))]
pub struct TestPontCryptoHasher(crate::hash::DefaultHasher);
// #[cfg(any(test, feature = "fuzzing"))]
impl ::core::clone::Clone for TestPontCryptoHasher {
    #[inline]
    fn clone(&self) -> TestPontCryptoHasher {
        match *self {
            TestPontCryptoHasher(ref __self_0_0) => {
                TestPontCryptoHasher(::core::clone::Clone::clone(__self_0_0))
            }
        }
    }
}
...
// #[cfg(any(test, feature = "fuzzing"))]
impl TestPontCryptoHasher {
    fn new() -> Self {
        let name = crate::_serde_name::trace_name::<TestPontCrypto>()
            .expect("The `CryptoHasher` macro only applies to structs and enums");
        TestPontCryptoHasher(crate::hash::DefaultHasher::new(name.as_bytes()))
    }
}
// #[cfg(any(test, feature = "fuzzing"))]
static TEST_CRYPTO_HASHER: crate::_once_cell::sync::Lazy<TestPontCryptoHasher> =
    crate::_once_cell::sync::Lazy::new(TestPontCryptoHasher::new);
// #[cfg(any(test, feature = "fuzzing"))]
impl std::default::Default for TestPontCryptoHasher {
    fn default() -> Self {
        TEST_CRYPTO_HASHER.clone()
    }
}
// #[cfg(any(test, feature = "fuzzing"))]
impl crate::hash::CryptoHasher for TestPontCryptoHasher {
...
// #[cfg(any(test, feature = "fuzzing"))]
impl std::io::Write for TestPontCryptoHasher {
...
// #[cfg(any(test, feature = "fuzzing"))]
impl crate::hash::CryptoHash for TestPontCrypto {
    type Hasher = TestPontCryptoHasher;
    fn hash(&self) -> crate::hash::HashValue {
        use crate::hash::CryptoHasher;
        let mut state = Self::Hasher::default();
        bcs::serialize_into(&mut state, &self)
            .expect("BCS serialization of TestPontCrypto should not fail");
        state.finish()
    }
}

/// Produces a random TestPontCrypto signable / verifiable struct.
#[cfg(any(test, feature = "fuzzing"))]
pub fn random_serializable_struct() -> impl Strategy<Value = TestPontCrypto> {
    (String::arbitrary()).prop_map(TestPontCrypto).no_shrink()
}
