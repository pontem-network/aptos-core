...
use crate::{
    ...
    test_utils::{TestPontCrypto, TEST_SEED},
    traits::*,
...
static MESSAGE: Lazy<TestPontCrypto> = Lazy::new(|| TestPontCrypto("Test Message".to_string()));
fn message() -> &'static TestPontCrypto {
    &MESSAGE
}
