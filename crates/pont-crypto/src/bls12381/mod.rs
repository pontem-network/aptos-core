...
//! ```
//! use std::iter::zip;
//! use pont_crypto::test_utils::{KeyPair, TestPontCrypto};
//! use pont_crypto::{bls12381, Signature, SigningKey, Uniform};
//! use pont_crypto::bls12381::bls12381_keys::{PrivateKey, PublicKey};
//! use pont_crypto::bls12381::ProofOfPossession;
//! use pont_crypto_derive::{CryptoHasher, BCSCryptoHash};
//! use rand_core::OsRng;
...
//! //
//! // Here, we'll sign an existing testing struct from `crates/pont-crypto/src/test_utils.rs`:
//! //
...
//! let message = TestPontCrypto("test".to_owned());
...
//! use pont_crypto::{bls12381, Signature, SigningKey, Uniform};
//! use pont_crypto::bls12381::bls12381_keys::{PrivateKey, PublicKey};
//! use pont_crypto::bls12381::{ProofOfPossession, UnvalidatedPublicKey};
//! use pont_crypto_derive::{CryptoHasher, BCSCryptoHash};
//! use rand_core::OsRng;
//! use serde::{Serialize, Deserialize};
//! use pont_crypto::validatable::Validatable;
//!
//! // NOTE: These were generated by running `cargo test -- doc_test --ignored --nocapture` in `crates/pont-crypto/`
...
//! // signature on TestPontCrypto("test".to_owned())
...
//! ```
//! use std::iter::zip;
//! use pont_crypto::test_utils::KeyPair;
//! use pont_crypto::{bls12381, Signature, SigningKey, Uniform};
//! use pont_crypto::bls12381::bls12381_keys::{PrivateKey, PublicKey};
//! use pont_crypto::bls12381::ProofOfPossession;
//! use pont_crypto_derive::{CryptoHasher, BCSCryptoHash};
