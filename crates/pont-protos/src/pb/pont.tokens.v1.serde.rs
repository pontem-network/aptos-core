...
impl serde::Serialize for CollectionData {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("pont.tokens.v1.CollectionData", len)?;
        if !self.creator_address.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct pont.tokens.v1.CollectionData")
            }
        ...
        deserializer.deserialize_struct("pont.tokens.v1.CollectionData", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Token {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("pont.tokens.v1.Token", len)?;
...
impl<'de> serde::Deserialize<'de> for Token {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct pont.tokens.v1.Token")
            }
        ...
        deserializer.deserialize_struct("pont.tokens.v1.Token", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for TokenData {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("pont.tokens.v1.TokenData", len)?;
...
impl<'de> serde::Deserialize<'de> for TokenData {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct pont.tokens.v1.TokenData")
            }
        ...
        deserializer.deserialize_struct("pont.tokens.v1.TokenData", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for TokenDataId {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("pont.tokens.v1.TokenDataId", len)?;
        if !self.creator_address.is_empty() {
            struct_ser.serialize_field("creatorAddress", &self.creator_address)?;
        }
        if !self.collection_name.is_empty() {
...
impl<'de> serde::Deserialize<'de> for TokenDataId {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct pont.tokens.v1.TokenDataId")
            }
        ...
        deserializer.deserialize_struct("pont.tokens.v1.TokenDataId", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for TokenId {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("pont.tokens.v1.TokenId", len)?;
        if let Some(v) = self.token_data_id.as_ref() {
            struct_ser.serialize_field("tokenDataId", v)?;
        }
        if self.property_version != 0 {
...
impl<'de> serde::Deserialize<'de> for TokenId {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct pont.tokens.v1.TokenId")
            }
        ...
        deserializer.deserialize_struct("pont.tokens.v1.TokenId", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Tokens {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("pont.tokens.v1.Tokens", len)?;
        if self.block_height != 0 {
            struct_ser.serialize_field(
                "blockHeight",
...
impl<'de> serde::Deserialize<'de> for Tokens {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct pont.tokens.v1.Tokens")
            }
        ...
        deserializer.deserialize_struct("pont.tokens.v1.Tokens", FIELDS, GeneratedVisitor)
    }
}
