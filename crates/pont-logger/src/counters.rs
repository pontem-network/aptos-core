...
pub static STRUCT_LOG_COUNT: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!("pont_struct_log_count", "Count of the struct logs.").unwrap()
});
...
pub static PROCESSED_STRUCT_LOG_COUNT: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!(
        "pont_struct_log_processed_count",
...
pub static SENT_STRUCT_LOG_COUNT: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!(
        "pont_struct_log_tcp_submit_count",
...
pub static SENT_STRUCT_LOG_BYTES: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!(
        "pont_struct_log_tcp_submit_bytes",
...
pub static STRUCT_LOG_TCP_CONNECT_COUNT: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!(
        "pont_struct_log_tcp_connect_count",
...
pub static STRUCT_LOG_QUEUE_ERROR_COUNT: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!(
        "pont_struct_log_queue_error_count",
...
pub static STRUCT_LOG_SEND_ERROR_COUNT: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!(
        "pont_struct_log_send_error_count",
...
pub static STRUCT_LOG_CONNECT_ERROR_COUNT: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!(
        "pont_struct_log_connect_error_count",
...
pub static STRUCT_LOG_PARSE_ERROR_COUNT: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!(
        "pont_struct_log_parse_error_count",
        "Count of all parse errors during struct logs."
    )
    .unwrap()
});

/// Counter for failed log ingest writes (see also: pont-telemetry for sender metrics)
pub static APTOS_LOG_INGEST_WRITER_FULL: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!(
        "pont_log_ingest_writer_full",
...
pub static APTOS_LOG_INGEST_WRITER_DISCONNECTED: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!(
        "pont_log_ingest_writer_disconnected",
