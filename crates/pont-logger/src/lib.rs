...
//! see the [coding guidelines](https://pont.dev/docs/core/coding-guidelines#logging).
//!
...
//!
//! ```
//! use pont_logger::{info, sample, sample::{SampleRate, Sampling}};
...
pub use crate::pont_logger::{
    LoggerFilterUpdater, PontData as Logger, PontDataBuilder, Writer, CHANNEL_SIZE,
};
pub use event::Event;
...
pub use pont_log_derive::Schema;
