...
pub(crate) const TELEMETRY_SERVICE_URL: &str = "https://telemetry.pontlabs.com";
pub(crate) const MAINNET_TELEMETRY_SERVICE_URL: &str = "https://telemetry.mainnet.pontlabs.com";
