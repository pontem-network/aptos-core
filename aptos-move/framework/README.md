...
* Documentation for the set of allowed transaction scripts in aptos-framework can be found in [script_documentation.md](aptos-move/framework/pont-framework/releases/artifacts/current/build/AptosFramework/docs/script_documentation.md).
* The overview documentation for the Move modules can be found in [overview.md](aptos-move/framework/pont-framework/releases/artifacts/current/build/AptosFramework/docs/overview.md).
* An overview of the approach to formal verification of the framework can be found in [spec_documentation.md](aptos-move/framework/pont-framework/releases/artifacts/current/build/AptosFramework/docs/spec_documentation.md).
