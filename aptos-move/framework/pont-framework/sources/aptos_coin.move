...
module pont_framework::aptos_coin {
    use std::string;
    use std::error;
    use std::signer;
    use std::vector;
    ...
    public(friend) fun initialize(pont_framework: &signer): (BurnCapability<AptosCoin>, MintCapability<AptosCoin>) {
    ...
    #[test_only]
    public fun initialize_for_test(pont_framework: &signer): (BurnCapability<AptosCoin>, MintCapability<AptosCoin>) {
