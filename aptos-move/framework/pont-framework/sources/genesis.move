module pont_framework::genesis {
    ...
    use pont_framework::aptos_coin::{Self, AptosCoin};
    use pont_framework::aptos_governance;
    ...
    fun initialize(
        ...
        aptos_governance::store_signer_cap(&pont_framework_account, @pont_framework, pont_framework_signer_cap);
    ...
    fun initialize_aptos_coin(pont_framework: &signer) {
        let (burn_cap, mint_cap) = aptos_coin::initialize(pont_framework);
        // Give stake module MintCapability<AptosCoin> so it can mint rewards.
        stake::store_aptos_coin_mint_cap(pont_framework, mint_cap);
        // Give transaction_fee module BurnCapability<AptosCoin> so it can burn gas.
        transaction_fee::store_aptos_coin_burn_cap(pont_framework, burn_cap);
    }
    ...
    fun initialize_core_resources_and_aptos_coin(
        ...
        aptos_coin::configure_accounts_for_test(pont_framework, &core_resources, mint_cap);
    }
    ...
    fun create_account(pont_framework: &signer, account_address: address, balance: u64): signer {
        if (account::exists_at(account_address)) {
            ...
            aptos_coin::mint(pont_framework, account_address, balance);
            account
        }
    }
    ...
    fun create_initialize_validators_with_commission(
        ...
        // validators.
        aptos_coin::destroy_mint_cap(pont_framework);
    ...
    fun initialize_for_verification(
        ...
        initialize_aptos_coin(pont_framework);
