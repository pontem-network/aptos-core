...
module pont_framework::staking_config {
    use std::error;
    ...
    public(friend) fun initialize(
        ...
        move_to(pont_framework, StakingConfig {
            minimum_stake,
            maximum_stake,
    ...
    public fun get(): StakingConfig acquires StakingConfig {
        *borrow_global<StakingConfig>(@pont_framework)
    }
    ...
    public fun update_required_stake(
        ...
        let staking_config = borrow_global_mut<StakingConfig>(@pont_framework);
    ...
    public entry fun test_change_staking_configs(pont_framework: signer) acquires StakingConfig {
        initialize(&pont_framework, 0, 1, 1, false, 1, 1, 1);

        update_required_stake(&pont_framework, 100, 1000);
        update_recurring_lockup_duration_secs(&pont_framework, 10000);
        update_rewards_rate(&pont_framework, 10, 100);
        update_voting_power_increase_limit(&pont_framework, 10);

        let config = borrow_global<StakingConfig>(@pont_framework);
    ...
    public entry fun test_update_required_stake_invalid_range_should_fail(pont_framework: signer) acquires StakingConfig {
        update_required_stake(&pont_framework, 10, 5);
    }

    #[test(pont_framework = @pont_framework)]
    #[expected_failure(abort_code = 0x10003)]
    public entry fun test_update_required_stake_zero_max_stake_should_fail(pont_framework: signer) acquires StakingConfig {
        update_required_stake(&pont_framework, 0, 0);
    }

    #[test(pont_framework = @pont_framework)]
    #[expected_failure(abort_code = 0x10001)]
    public entry fun test_update_required_lockup_to_zero_should_fail(pont_framework: signer) acquires StakingConfig {
        update_recurring_lockup_duration_secs(&pont_framework, 0);
    }

    #[test(pont_framework = @pont_framework)]
    #[expected_failure(abort_code = 0x10002)]
    public entry fun test_update_rewards_invalid_denominator_should_fail(pont_framework: signer) acquires StakingConfig {
        update_rewards_rate(&pont_framework, 1, 0);
    }
    ...
    public entry fun test_update_voting_power_increase_limit_to_zero_should_fail(
        ...
        update_voting_power_increase_limit(&pont_framework, 0);
    }
    ...
    public entry fun test_update_voting_power_increase_limit_to_more_than_upper_bound_should_fail(
        ...
        update_voting_power_increase_limit(&pont_framework, 51);
    }
    ...
    public fun initialize_for_test(
        ...
        if (!exists<StakingConfig>(@pont_framework)) {
            move_to(pont_framework, StakingConfig {
                minimum_stake,
                maximum_stake,
                recurring_lockup_duration_secs,
