...
//! documentation within `crates/pont-openapi`.
//!
...
//! https://github.com/aptos-labs/pont-core/issues/2319.
...
// https://github.com/aptos-labs/pont-core/pull/2703

use pont_openapi::{impl_poem_parameter, impl_poem_type};
use serde_json::json;
...
impl_poem_type!(
    ...
    (
        ...
        description = Some(indoc! {"
            A hex encoded 32 byte Pont account address.
...
impl_poem_type!(
    ...
    "string",
    (
        example = Some(serde_json::Value::String("0x1::pont_coin".to_string())),
        description = Some(indoc! {"
...
impl_poem_type!(
    ...
    (
        example = Some(serde_json::Value::String(
            "0x1::coin::CoinStore<0x1::pont_coin::PontCoin>".to_string()
        )),
        ...
        See [doc](https://pont.dev/concepts/basics-accounts) for more details.
      "})
    )
);
...
impl_poem_type!(
    ...
    (
        ...
        description = Some(indoc! {"
            ...
            Move `address` type value (32 byte Pont account address) is serialized into a HexEncodedBytes string.
            For example:
              - `0x1`
            ...
            **Special serialization for Move stdlib types**:
              - [0x1::string::String](https://github.com/aptos-labs/pont-core/blob/main/language/move-stdlib/docs/ascii.md)
        ...
        description = Some(indoc! {"
            String representation of an on-chain Move type tag that is exposed in transaction payload.
                ...
                Vector type value examples:
                  - `vector<u8>`
                  - `vector<vector<u64>>`
                  - `vector<0x1::coin::CoinStore<0x1::pont_coin::PontCoin>>`
...
impl_poem_type!(
    ...
    (
        example = Some(serde_json::Value::String(
            "0x1::pont_coin::transfer".to_string()
        )),
        description = Some(indoc! {"
