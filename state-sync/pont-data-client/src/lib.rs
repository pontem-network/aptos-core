...
/// An error returned by the Pont Data Client for failed API calls.
...
/// The API offered by the Pont Data Client.
#[async_trait]
pub trait PontDataClient {
...
/// A response error that users of the Pont Data Client can use to notify
...
/// A snapshot of the global state of data available in the Pont network.
