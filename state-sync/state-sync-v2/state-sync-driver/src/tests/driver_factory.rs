...
use pont_genesis::test_utils::test_config;
use pont_infallible::RwLock;
use pont_temppath::TempPath;
use pont_time_service::TimeService;
use pont_types::on_chain_config::ON_CHAIN_CONFIG_REGISTRY;
use pont_vm::PontVM;
use pontdb::PontDB;
...
fn test_new_initialized_configs() {
    ...
    bootstrap_genesis::<PontVM>(&db_rw, get_genesis_txn(&node_config).unwrap()).unwrap();
