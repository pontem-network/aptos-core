...
impl From<pont_secure_storage::Error> for Error {
    fn from(error: pont_secure_storage::Error) -> Self {
        match error {
            pont_secure_storage::Error::PermissionDenied => {
            ...
            pont_secure_storage::Error::KeyVersionNotFound(_, _)
            | pont_secure_storage::Error::KeyNotSet(_) => {
