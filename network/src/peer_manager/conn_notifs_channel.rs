...
pub type Sender = pont_channel::Sender<PeerId, ConnectionNotification>;
pub type Receiver = pont_channel::Receiver<PeerId, ConnectionNotification>;

pub fn new() -> (Sender, Receiver) {
    pont_channel::new(QueueStyle::LIFO, 1, None)
}
