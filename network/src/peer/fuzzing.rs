...
pub fn fuzz(data: &[u8]) {
    ...
    let (peer_reqs_tx, peer_reqs_rx) = pont_channel::new(QueueStyle::FIFO, channel_size, None);
    let (peer_notifs_tx, peer_notifs_rx) = pont_channel::new(QueueStyle::FIFO, channel_size, None);
