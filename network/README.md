...
id: network
title: Network
custom_edit_url: https://github.com/aptos-labs/pont-core/edit/main/network/README.md
---

## Overview

For more detailed info, see the [PontNet Specification](../documentation/specifications/network/README.md).

PontNet is the primary protocol for communication between any two nodes in the
Pont ecosystem. It is specifically designed to facilitate the consensus, shared
mempool, and state sync protocols. PontNet tries to maintain at-most one connection
...
+ [`PontTransport`] &mdash; A secure, reliable transport. It uses [NoiseIK] over
TCP to negotiate an encrypted and authenticated connection between peers.
The PontNet version and any Pont-specific application protocols are negotiated
afterward using the [PontNet Handshake Protocol].
...
## How is this module organized?
    ...
    └── src
        ...
        │   └── wire               # Protocol for PontNet handshakes and messaging
...
[`PontNet Handshake Protocol`]: ../specifications/network/handshake-v1.md
[`ValidatorSet::validators`]: ../pont-move/framework/core/doc/ValidatorSet.md#struct-ValidatorSet
[`PontTransport`]: ./src/transport/mod.rs
...
[`ValidatorConfig`]: ../pont-move/framework/core/doc/ValidatorConfig.md#struct-config
