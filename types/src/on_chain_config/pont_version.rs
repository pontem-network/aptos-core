...
/// Defines the version of Pont Validator software.
...
// NOTE: version number for release 1.2 Pont
...
// NOTE: version number for release 1.3 of Pont
// Items gated by this version number include:
//  - Multi-agent transactions
pub const APTOS_VERSION_3: Version = Version { major: 3 };

// NOTE: version number for release 1.4 of Pont
// Items gated by this version number include:
