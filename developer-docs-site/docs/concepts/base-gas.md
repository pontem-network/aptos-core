...
As explained in the [optimization principles](#optimization-principles) section, storage gas has by far the largest effect on base gas. For background on the Pont gas model, see [The Making of the Pont Gas Schedule](https://pontlabs.medium.com/the-making-of-the-pont-gas-schedule-508d5686a350).
