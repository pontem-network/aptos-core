---
title: "Handling Errors in Pont and Move"
slug: "handle-pont-errors"
---
import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

# Handling Errors in Pont and Move

This page catalogs common errors encountered in the Pont blockchain and explains how to resolve them wherever possible. As with all software, the code itself is the source of truth for error handling and will always contain entries not found here. Instead, this matrix aims to help you address those errors most typically found, misunderstood, or both.
...
For the sources of these errors, see:
  ...
  * [error.move](https://github.com/aptos-labs/pont-core/blob/main/pont-move/framework/move-stdlib/sources/error.move)
  * [account.move](https://github.com/aptos-labs/pont-core/blob/main/pont-move/framework/pont-framework/sources/account.move)
  * [coin.move](https://github.com/aptos-labs/pont-core/blob/main/pont-move/framework/pont-framework/sources/coin.move)
  * [token.move](https://github.com/aptos-labs/pont-core/blob/main/pont-move/framework/pont-token/sources/token.move)
  * [token_transfers.move](https://github.com/aptos-labs/pont-core/blob/main/pont-move/framework/pont-token/sources/token_transfers.move)
...
|ENO_VALID_FRAMEWORK_RESERVED_ADDRESS|Address to create is not a valid reserved address for Pont framework.|
