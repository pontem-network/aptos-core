...
When running a fullnode on an Pont network, you can configure your node's
...
- Connecting your fullnode to an Pont blockchain deployment.
...
See [Pont Blockchain Deployments](/nodes/pont-deployments) for more information.
...
Peer ID is synonymous with `AccountAddress`. See [NetworkAddress](https://github.com/aptos-labs/pont-core/blob/main/documentation/specifications/network/network-address.md) to see how the `addresses` key value is constructed.

:::

## Connecting your fullnode to an Pont blockchain deployment

When running a fullnode on an Pont blockchain deployment, your node will be
...
waypoint for your fullnode to ensure your node connects to the correct Pont
blockchain deployment. See [Pont Blockchain Deployments](/nodes/pont-deployments)
for more information.

## Connecting your fullnode to seed peers

All Pont fullnodes are configured to accept a maximum number of network
...
`No connected PontNet peers!` or `Unable to fetch peers to poll!`.
...
You may see `No connected PontNet peers!` or `Unable to fetch peers to poll!` in your node's error messages. This is normal when the node is first starting.
...
You can also use the fullnode addresses provided by the Pont community. Anyone already running a fullnode can provide their address for you to connect. See the Pont Discord.
