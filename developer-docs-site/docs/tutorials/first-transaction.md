...
The `transfer-coin` example code uses helper functions to interact with the [REST API](https://fullnode.devnet.pontlabs.com/v1/spec#/). This section reviews each of the calls and gives insights into functionality.
