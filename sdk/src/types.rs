...
/// LocalAccount represents an account on the Pont blockchain. Internally it
...
impl LocalAccount {
    ...
    /// does not actually create an account on the Pont blockchain, just a
    ...
    /// create an account on the Pont blockchain, it just generates a new
    /// account locally.
