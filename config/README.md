...
post](https://pont.dev/blog/2020/01/23/full-node-basics).
...
specifies the specific node config to return. This can be used to create an Pont
...
- NetworkConfig - PontNet configuration file that specifies peers with keys,
...
- StorageConfig - Where the PontDB is stored and its gRPC service endpoints
